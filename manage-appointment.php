...
$aid = "";
if (isset($_GET['aid'])) {
    $aid = intval(base64_decode(urldecode(mysqli_real_escape_string($db_con, xss_clean($_GET['aid'])))));
    //clear user notification
    $getUserID = mysqli_query($db_con, "update appointments set notify_status=1 WHERE id='$aid' ") or die("Error " . mysqli_error($db_con));
}
//$aid = intval(base64_decode(urldecode($_GET['aid'])));
?>
<!-- Plugin Css-->
        ...
        <div class="content-page">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ol class="breadcrumb">
                                <li>
                                    <a href="manage-appointment"><?php echo $lang['appoint']; ?></a>
                                </li>
                                <li class="active"><?php echo $lang['view_all_appointment']; ?></li>
                                <li> <a href="#" data-toggle="modal" data-target="#help-modal" id="helpview" data="32" title="<?= $lang['help']; ?>"><i class="fa fa-question-circle"></i> </a></li>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <?php if ($rwgetRole['appoint_add'] == '1') { ?>
                                            <div class="col-sm-1">
                                                <a href="add-appointment" class="btn btn-primary waves-effect waves-light" style="height:36px;"> <?php echo $lang['Add']; ?> <i class="fa fa-calendar-plus-o"></i></a>
                                            </div>
                                        <?php } ?>
                                        ...
                                        <div class="form-group col-md-3">
                                            <select class="select2" name="tddt" id="tddt">
                                                ...
                                                <?php
                                                $tddt = base64_decode(urldecode(xss_clean($_GET['tddt'])));
                                        ...
                                        <div class="form-group col-md-1">
                                            <a href="manage-appointment" class="btn btn-warning" title="<?php echo $lang['Reset']; ?>"><?php echo $lang['Reset']; ?></a>
                                        </div>
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    $users = mysqli_query($db_con, "select * from appointments $where order by id desc LIMIT $start, $per_page");
                                                    ...
                                                    ?>
                                                    <div class="form-group no-records-found"><label><?= $lang['no_appoint_found']; ?></label></div>
                                                <?php }
                                                ?>
                                                </div>
                                            </div>
                        ...
                        <div class="modal-content">
                            <form method="post">
                                ...
                                <div class="modal-body">
                                    <p style="color: red;"><?php echo $lang['aysywtaa']; ?></p>
                                </div>
                                ...
                                <div class="modal-footer">
                                    <div class="col-md-12 text-right">
                                        ...
                                        <button type="submit" name="delete" id="dialogConfirm" class="btn btn-danger waves-effect waves-light"><i class="fa fa-archive"> <?php echo $lang['archive']; ?></i></button>
                        ...
                        <div class="modal-content">
                            <form action="multi-export-user-data" method="post">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    <label>
                                        <h2 class="panel-title"><?php echo $lang['Export_Listed_User_Lists']; ?></h2>
                                    </label>
                                </div>
                                <div class="modal-body">
                        ...
                        <div class="modal-content">
                            <form method="post">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    <label>
                                        <h2 class="panel-title"><?= $lang['ARE_YOU_SURE'] ?>?</h2>
                                    </label>
                                </div>
                                <div class="modal-body">
            ...
            <script>
                ...
                $("a#editRow").click(function() {
                    ...
                    $.post("application/ajax/updateUser.php", {
                        ID: $id
                ...
                <table class="table table-striped table-bordered js-sort-table" id="table_demo_icons">
                    <thead>
                        <tr>
                            ...
                            <th class="sort-js-date"><?php echo $lang['Date']; ?></th>
                            <th class="sort-js-date"><?php echo $lang['time']; ?></th>
                            <th class="sort-js-date"><?php echo $lang['noty_time']; ?></th>
                            <th><?php echo $lang['noty_freq']; ?></th>
                            <th><?php echo $lang['agenda']; ?></th>
                            <th><?php echo $lang['notes']; ?></th>

                            <?php if ($rwgetRole['appoint_edit'] == '1' || $rwgetRole['appoint_archive'] == '1') { ?>
                    ...
                    <tbody>
                        ...
                        while ($rwUser = mysqli_fetch_assoc($user)) {
                            $tnf = $rwUser['notify_frequency'];
                        ?>
                            <tr class="gradeX">
                                <td><?php echo $i . '.'; ?></td>
                                <td>
                                    <?php echo $rwUser['title']; ?>
                                </td>
                                <td><?php echo date('d-m-Y', strtotime($rwUser['app_date'])) ?> </td>
                                <td><?php echo date('h:i A', strtotime($rwUser['app_time'])); ?> </td>
                                <td><?php echo date('h:i A', strtotime($rwUser['notify_time'])); ?> </td>
                                <td><?php echo ($tnf == '0' ? 'Same Day' : $tnf . ($tnf > '1' ? " days" : " day") . ' before'); ?> </td>
                                <td><?php echo $rwUser['agenda']; ?></td>
                                <td><?php echo $rwUser['app_notes']; ?> </td>
                                <td class="actions" style="width: 12%">
                                    <?php if ($rwgetRole['appoint_edit'] == '1') { ?>
                                        <a href="add-appointment?aid=<?= urlencode(base64_encode($rwUser['id'])) ?>" class="on-default edit-row btn btn-primary" title="<?php echo $lang['edit_appointment']; ?>"><i class="fa fa-edit"></i></a>
                                    <?php } ?>
                                    <?php if ($rwgetRole['appoint_archive'] == '1') { ?>
                                        <a href="#" class="on-default remove-row btn btn-danger" data-toggle="modal" data-target="#dialog" id="removeRow" data="<?php echo $rwUser['id']; ?>" title="<?php echo $lang['archive_appointment']; ?>"><i class="fa fa-archive"></i></a>
                                    <?php } ?>
...
if (isset($_POST['delete'])) {
    ...
    $query = mysqli_query($db_con, "update appointments set is_archived='1' where id='$del_id'");

    if ($query) {
        echo '<script>taskSuccess("manage-appointment","' . $lang['appoint_archived'] . '");</script>';
    } else {
        echo '<script>taskFailed("manage-appointment","' . $lang['uta'] . '");</script>';
    }
    mysqli_close($db_con);
}
?>