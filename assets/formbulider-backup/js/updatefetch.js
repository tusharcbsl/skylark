jQuery(function ($) {
  ...
  var setFormData = document.getElementById("formjsondata").value;
  ...
  fbPromise.then(function (fb) {
    ...
    document.getElementById('getJSON').addEventListener('click', function () {
      ...
      if (workflowname == "" || group == "") {
        ...
        $.post("application/ajax/updateWorkf.php", { data: formBuilder.actions.getData('json', true), workflowName: workflowname, groups: groups, formRequire: chkbox, pdfreq: pdfreq, rfi: rfi, wfid: wid, formid: fid, token: token }, function (result, status) {
          if (status == 'success') {
            $("#chkhide").hide();
            $("#data").html(result);
