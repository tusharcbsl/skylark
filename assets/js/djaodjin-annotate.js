      ...
      switch (self.options.type) {
        case 'rectangle':
          ...
          self.drawRectangle(self.drawingContext, self.fromx, self.fromy,
            self.tox, self.toy);
            var drawrec = $("#drawrec").val();
            if(drawrec == ""){
                $("#drawrec").val('Rectangle');
            }
          break;
        case 'arrow':
          self.clear();
        ...
        case 'pen':
          ...
          self.drawPen(self.drawingContext, self.fromx, self.fromy, self.tox,
            ...
            var drawpen = $("#drawpen").val();
            if(drawpen==""){
                $("#drawpen").val("Draw text");
            }
          break;
        case 'text':
          self.clear();
        ...
        case 'circle':
          ...
          self.drawCircle(self.drawingContext, self.fromx, self.fromy,
            self
            .tox, self.toy);
            var drawcircle = $("#drawcircle").val();
            if(drawcircle==""){
                $("#drawcircle").val("Circle");
            }
          break;
        default:
      }
