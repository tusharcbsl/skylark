...
(function(o){
	...
	getFormData = function(source){
		...
		data.append('storage', document.getElementById('storage').value);
                data.append('paths', document.getElementById('paths').value);
                data.append('uploadfolder', true);
                data.append('optradio', document.getElementsByName('optradio').value);
