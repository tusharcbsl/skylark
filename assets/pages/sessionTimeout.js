...
//var sessionTimeout = 1 * 900000;
var sessionTimeout = 1 * 1000;
...
function initSessionMonitor() {
    ...
    $(document).bind('click keyup', function (ed, e) {
...
$("#btnSessionExpiredCancelled").click(function () {
	...
	clearInterval(idleIntervalID);
    clearInterval(remainingTimer);
	var currurl=$("#btnSessionExpiredCancelled").val();
	 location.reload();
...
function countdownDisplay() {
    ...
    remainingTimer = setInterval(function () {
        if (localStorage.getItem('sessionSlide') == "isStarted") {
            ...
            {
                //console.log(dialogDisplaySeconds);
