var PdfFlip = {
    ...
    layout: 'double',
    maxScale: 2,
    audioSrc: "flipbookviewer/sound/page-flip.mp3",
    init: function () {
                     ...
                     var wmCanvas=document.createElement("canvas");
                          ...
                          // setup text for filling
                           ...
                           // // as the origin is now at the center, just need to center the text
                            ...
                            if($(destinationCanvas).firstChild)
                               $(destinationCanvas).insertBefore(wmCanvas, div.firstChild);
                            else
                              $(destinationCanvas).append(wmCanvas);
