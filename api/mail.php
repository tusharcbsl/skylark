...
<table class="body-wrap" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; background-color: #f6f6f6; margin: 0;" bgcolor="#f6f6f6"><tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"><td style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0;" valign="top"></td>
		<td class="container" width="600" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; display: block !important; max-width: 600px !important; clear: both !important; margin: 0 auto;" valign="top">
			<div class="content" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; max-width: 600px; display: block; margin: 0 auto; padding: 20px;">
				<table class="main" width="100%" cellpadding="0" cellspacing="0" itemprop="action" itemscope itemtype="http://schema.org/ConfirmAction" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; border-radius: 3px; background-color: #fff; margin: 0; border: 1px solid #e9e9e9;" bgcolor="#fff"><tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"><td class="content-wrap" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 20px;" valign="top">
							<meta itemprop="name" content="Confirm Email" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;" /><table width="100%" cellpadding="0" cellspacing="0" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"><tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"><td class="content-block" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
										Your OTP for Changing Password on http://'. $_SERVER['HTTP_HOST'] . ' is <br>
                                                                                
										<strong>OTP </strong> - ' . $txt . '<br>
										<strong>(Your OTP Expired Within 10 min.)</strong> <br>
									</td>
								</tr><tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"><td class="content-block" itemprop="handler" itemscope itemtype="http://schema.org/HttpActionHandler" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
										This is a System Generated mail please do not reply.
									</td>
...
function assignTask($ticket, $id, $con, $projectName,$userid) {


  /*  echo "select * from tbl_doc_assigned_wf where id='$id' and NextTask='0'";
    die;*/
  ...
  //$endDate = date('Y-m-d H:i:s');
    ...
    $task = mysqli_query($con, "select * from tbl_doc_assigned_wf where id='$id' and NextTask='0'") or die('Error:' . mysqli_error($con));
    ...
    if (mysqli_num_rows($task) > 0) {
       ...
       /* echo $rwTask['task_status']; 
        ...
        $work = mysqli_query($con, "select * from tbl_task_master where task_id='$rwTask[task_id]'") or die('Error:' . mysqli_error($con));
        $rwWork = mysqli_fetch_assoc($work);
        $taskname =  $rwWork['task_name'];
        $taskInstruction= $rwWork['task_instructions'];

        /*echo $rwWork['priority_id'];
        die;*/
        ...
        $wfn = mysqli_query($con, "select * from tbl_workflow_master where workflow_id='$rwWork[workflow_id]'") or die('Error:' . mysqli_error($con));
...
*/
        ...
        $stn = mysqli_query($con, "select * from tbl_step_master where step_id='$rwWork[step_id]'") or die('Error:' . mysqli_error($con));
    ...
    /*    echo $rwTask['doc_id'];
        ...
        if ($rwTask['doc_id'] != '0') {
            ...
            $dms = mysqli_query($con, "select * from tbl_document_master where doc_id='$rwTask[doc_id]'") or die('Error:' . mysqli_error($con));
            $rwDms = mysqli_fetch_assoc($dms);
            $oldDocName = $rwDms['old_doc_name'];

        }

        $user = mysqli_query($con, "select first_name,last_name from tbl_user_master where user_id='$rwTask[assign_by]'") or die('Error:' . mysqli_error($con));
        $rwUser = mysqli_fetch_assoc($user);
        $asinBy = $rwUser['first_name'] . ' ' . $rwUser['last_name'];

        //$tskId = $rwTask['task_id'];
        //$taskRe = mysqli_query($con, "select * from tbl_task_master where task_id='$tskId'") or die('Error:'.mysqli_error($con));
        //$rwTaskRe = mysqli_fetch_assoc($taskRe);

        $asinUser = $rwWork['assign_user'];
        $asinUserId = mysqli_query($con, "select * from tbl_user_master where user_id='$asinUser'") or die('Error:' . mysqli_error($con));
        ...
        $altrUserId = mysqli_query($con, "select * from tbl_user_master where user_id='$altruser'") or die('Error:' . mysqli_error($con));
        ...
        $suprUserId = mysqli_query($con, "select * from tbl_user_master where user_id='$suprvsr'") or die('Error:' . mysqli_error($con));
...
<table class="body-wrap" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; background-color: #f6f6f6; margin: 0;" bgcolor="#f6f6f6">
    <tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
        ...
        if (!$mail->send()) {
            ...
            $msgbody = mysqli_real_escape_string($con, $msgbody);
            $mailsent = mysqli_query($con, "insert into tbl_mail_list(`send_by`, `send_to`, `send_cc`, `send_bcc`, `subject`, `mail_body`, `alt_body`, `mail_time`, `ip`, `module_name`) "
                    . "value('$sender','$asinUserEmail','$sendCC','','New Task Assigned !','$msgbody','New Notifiation from $projectName','$date','$host','Assign Task')") or die('Error' . mysqli_error($con));
            return true;
        }
    }
}
...
function rejectTask($id, $taskId, $ticket, $con, $projectName,$comment,$doc_id,$userid) {
  ...
  $taskname = "";
    ...
    $task = mysqli_query($con, "select * from tbl_doc_assigned_wf where id='$id' and NextTask=2") or die('Error:' . mysqli_error($con));
    if (mysqli_num_rows($task) > 0) {
        $rwTask = mysqli_fetch_assoc($task);
        ...
        $user = mysqli_query($con, "select * from tbl_user_master where user_id='$rwTask[assign_by]'") or die('Error:' . mysqli_error($con));
        $rwUser = mysqli_fetch_assoc($user);
        $asinBy = $rwUser['first_name'] . ' ' . $rwUser['last_name'];
        ...
        $rejctByUser = mysqli_query($con, "select * from tbl_user_master where user_id='$rejectByid'") or die('Error:' . mysqli_error($con));
        ...
        $dc_paths = mysqli_query($con, "SELECT old_doc_name,doc_path,doc_name FROM `tbl_document_master` WHERE doc_id='$rwTask[doc_id]'") or die('Error:' . mysqli_error($con));
        //die;
        ...
        $fileVersion = mysqli_query($con, "SELECT old_doc_name,doc_path,doc_name FROM `tbl_document_master` WHERE doc_name='$updateDocName'") or die('Error:' . mysqli_error($con));
        if (!empty($taskDesc)) {
            $des = '<b>Description :</b> <p>' . $taskDesc . '</p>';
        }
...
<table class="body-wrap" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; background-color: #f6f6f6; margin: 0;" bgcolor="#f6f6f6">
    <tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
        ...
        $getAprovBy = mysqli_query($con, "select tum.first_name, tum.last_name, tum.user_email_id FROM tbl_doc_assigned_wf tda INNER JOIN  tbl_user_master tum ON tda.action_by = tum.user_id where tda.ticket_id = '$ticketId' ") or die('Error:' . mysqli_error($con));
        $cc = array();
        ...
        if (!$mail->send()) {
            ...
            $msgbody = mysqli_real_escape_string($con, $msgbody);
            $mailsent = mysqli_query($con, "insert into tbl_mail_list(`send_by`, `send_to`, `send_cc`, `send_bcc`, `subject`, `mail_body`, `alt_body`, `mail_time`, `ip`, `module_name`) "
                    . "value('$sender','$asinByEmail','$sendCC','','Task Rejected !','$msgbody','New Notifiation from $projectName','$date','$host','Reject Task')") or die('Error' . mysqli_error($con));
            return true;
        }
    }
}

function completeTask($ticket, $id, $wfid, $con, $projectName,$userid) {
...
$normal = "";
 $taskInstructions = "";
  ...
  $endDate = 0;
    ...
    $task = mysqli_query($con, "select * from tbl_doc_assigned_wf where id='$id' and NextTask='1'") or die('Error:' . mysqli_error($con));
    if (mysqli_num_rows($task) > 0) {
        $rwTask = mysqli_fetch_assoc($task);
        $taskstatus = $rwTask['task_status'];
        ...
        $work = mysqli_query($con, "select * from tbl_task_master where task_id='$rwTask[task_id]'") or die('Error:' . mysqli_error($con));
        $rwWork = mysqli_fetch_assoc($work);
        $taskInstructions = $rwWork['task_instructions'];
  ...
  $endDate = 0; 
        ...
        //get asign by detail      
        $getAsinBy = mysqli_query($con, "select tum.user_email_id, tum.first_name, tum.last_name, tda.start_date from tbl_doc_assigned_wf tda inner join tbl_user_master tum on tda.assign_by = tum.user_id where tda.ticket_id = '$ticket'") or die('Error:' . mysqli_error($con));
        ...
        //get work flow name
        $workflowName = mysqli_query($con, "select * from tbl_workflow_master where workflow_id='$wfid'") or die('Error:' . mysqli_error($con));
...
/*
       ...
       /*  echo "SELECT old_doc_name,doc_path,doc_name FROM `tbl_document_master` WHERE doc_name='$updateDocName'";
         die; */
        $fileVersion = mysqli_query($con, "SELECT * FROM `tbl_document_master` WHERE doc_name='$updateDocName'")
         or
        ...
        $taskHistry = mysqli_query($con, "select ttc.task_status, ttc.comment_time, tum.first_name, tum.last_name, ttm.task_name, ttc.comment from tbl_doc_assigned_wf tda inner join tbl_task_comment ttc on (tda.ticket_id = ttc.tickt_id and tda.task_id = ttc.task_id) inner join tbl_user_master tum on (tum.user_id = tda.action_by) inner join tbl_task_master ttm on ttm.task_id = tda.task_id where tda.ticket_id='$ticket' and tda.NextTask='1' order by ttc.comment_time desc") or die('Error:' . mysqli_error($con));
...
<table class="body-wrap" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; background-color: #f6f6f6; margin: 0;" bgcolor="#f6f6f6">
    <tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
        ...
        $mail->addBCC("ezeefileadmin@cbsl-india.com", "Admin");
        $getAprovBy = mysqli_query($con, "select tum.first_name, tum.last_name, tum.user_email_id FROM tbl_doc_assigned_wf tda INNER JOIN  tbl_user_master tum ON tda.action_by = tum.user_id where tda.ticket_id = '$ticket' ") or die('Error:' . mysqli_error($con));
        $cc = array();
   ...
   $mail->addStringAttachment(file_get_contents($file),$dcName);
        ...
        if (!$mail->send()) {
            ...
            $msgbody = mysqli_real_escape_string($con, $msgbody);
            $mailsent = mysqli_query($con, "insert into tbl_mail_list(`send_by`, `send_to`, `send_cc`, `send_bcc`, `subject`, `mail_body`, `alt_body`, `mail_time`, `ip`, `module_name`) "
                    . "value('$sender','$getAsinByEmail','$sendCC','','Task has been Completed !','$msgbody','New Notifiation from $projectName','$date','$host','Task Completed')") or die('Error' . mysqli_error($con));
            return true;
        }
    }
}

function mailSendAccounts($msgbody1, $mailFrom, $subject, $dbc, $projectName,$userid) {
...
function assignTaskAlternate($id, $con, $projectName,$userid) {


    $task = mysqli_query($con, "select * from tbl_doc_assigned_wf where id='$id' and NextTask=3") or die('Error:' . mysqli_error($con));
...
<table class="body-wrap" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; background-color: #f6f6f6; margin: 0;" bgcolor="#f6f6f6">
    <tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
        ...
        if (!$mail->send()) {
            ...
            $msgbody = mysqli_real_escape_string($con, $msgbody);
            $mailsent = mysqli_query($con, "insert into tbl_mail_list(`send_by`, `send_to`, `send_cc`, `send_bcc`, `subject`, `mail_body`, `alt_body`, `mail_time`, `ip`, `module_name`) "
                    . "value('$sender','$altrUserEmail','$sendCC','','Task assigned to alternate user!','$msgbody','New Notifiation from $projectName','$date','$host','Assign Task to Alternate User')") or die('Error' . mysqli_error($con));
            return true;
        }
    } else {
        return false;
...
function assignTaskSupervisor($id, $con, $projectName,$userid) {
...
<table class="body-wrap" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; background-color: #f6f6f6; margin: 0;" bgcolor="#f6f6f6">
    <tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
        ...
        if (!$mail->send()) {
            ...
            $msgbody = mysqli_real_escape_string($con, $msgbody);
            $mailsent = mysqli_query($con, "insert into tbl_mail_list(`send_by`, `send_to`, `send_cc`, `send_bcc`, `subject`, `mail_body`, `alt_body`, `mail_time`, `ip`, `module_name`) "
                    . "value('$sender','$suprUserEmail','$sendCC','','Task assigned to Supervisor!','$msgbody','New Notifiation from $projectName','$date','$host','Assign Task to Superwiser')") or die('Error' . mysqli_error($con));
            return true;
        }
    } else {
        return false;
...
function abortTask($ticket, $id, $wfid, $con, $projectName,$userid) {
...
$normal = "";
 $taskInstructions = "";
  ...
  $taskstatus = "";
    ...
    $task = mysqli_query($con, "select * from tbl_doc_assigned_wf where id='$id' and NextTask='5'") or die('Error:' . mysqli_error($con));
    if (mysqli_num_rows($task) > 0) {
        $rwTask = mysqli_fetch_assoc($task);
         $taskstatus = $rwTask['task_status'];
  ...
  $endDate = 0; 
       ...
       $updateDocName = $docName[0] . '_' .$rwTask['doc_id'];
        ...
        $taskHistry = mysqli_query($con, "select * from tbl_doc_assigned_wf tda inner join tbl_task_comment ttc on tda.ticket_id = ttc.tickt_id and tda.task_id = ttc.task_id inner join tbl_user_master tum on tum.user_id = tda.action_by inner join tbl_task_master ttm on ttm.task_id = tda.task_id where tda.ticket_id='$ticket' and tda.NextTask='1' order by tda.action_time desc") or die('Error:' . mysqli_error($con));
...
<table class="body-wrap" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; background-color: #f6f6f6; margin: 0;" bgcolor="#f6f6f6">
    <tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
        ...
        if (!$mail->send()) {
            ...
            $msgbody = mysqli_real_escape_string($con, $msgbody);
            $mailsent = mysqli_query($con, "insert into tbl_mail_list(`send_by`, `send_to`, `send_cc`, `send_bcc`, `subject`, `mail_body`, `alt_body`, `mail_time`, `ip`, `module_name`) "
                    . "value('$sender','$getAsinByEmail','$sendCC','','Task has been Aborted !','$msgbody','New Notifiation from $projectName','$date','$host','Task is Aborted')") or die('Error' . mysqli_error($con));
            return true;
        }
    }
}
...
<table class="body-wrap" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; background-color: #f6f6f6; margin: 0;" bgcolor="#f6f6f6"><tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"><td style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0;" valign="top"></td>
		<td class="container" width="600" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; display: block !important; max-width: 600px !important; clear: both !important; margin: 0 auto;" valign="top">
			<div class="content" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; max-width: 600px; display: block; margin: 0 auto; padding: 20px;">
				<table class="main" width="100%" cellpadding="0" cellspacing="0" itemprop="action" itemscope itemtype="http://schema.org/ConfirmAction" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; border-radius: 3px; background-color: #fff; margin: 0; border: 1px solid #e9e9e9;" bgcolor="#fff"><tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"><td class="content-wrap" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 20px;" valign="top">
							<meta itemprop="name" content="Confirm Email" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;" /><table width="100%" cellpadding="0" cellspacing="0" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"><tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"><td class="content-block" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
										Your  Verification Code for login on http://'. $_SERVER['HTTP_HOST'] . ' is <br>
