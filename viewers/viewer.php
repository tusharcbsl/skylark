...
//if(!isset($_SESSION['admin_user_name']) || (isset($_SESSION['admin_user_name']) && $_SESSION['admin_user_name']!== true))
//{
    ?>
                                                            ...
                                                            <div class="ctext-wrap">
                                                                <span><?php
                                                                    ...
                                                                    if (!empty($rwcomment['comment'])) {
                                                                        ...
                                                                        if ($ext) {
                                                                            ?>
                                                                            <a href="anott/view?cid=<?= urlencode(base64_encode($rwcomment['id'])) ?>" target="_blank"><i class="fa fa-file cmt-file"></i></a><?php
                                                                        } else {
                        ...
                        <?php if ($rwgetRole['file_coment'] == '1' && (isset($rwTask['ticket_id']) && isset($rwTask['task_id']) )) { ?>
                            <div class="row" >
                                ...
                                <div class="comment-list-form1">
                                    ...
                                    <button data-toggle="modal" data-target="#con-close-modal-comment" class="btn btn-primary btn-sm add m-l-5" id="comment" style="margin-top:4px;" title="Add Comment">Add Comment
                                    </button>
