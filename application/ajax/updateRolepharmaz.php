...
<div class="row"> 
    ...
    <table style="width:100%;">
        ...
        <?php } ?>
        <?php if ($rwgetRole['bulk_upload'] == '1' || $rwgetRole['folder_upload']) { ?>
            <tr>
                <td>   
                    <div class="checkbox checkbox-success txt">
        ...
        <?php } if ($rwgetRole['file_edit'] == '1' || $rwgetRole['file_delete'] == '1' || $rwgetRole['file_anot'] == '1' || $rwgetRole['file_anot_delete'] == '1') { ?>
            <tr>
        ...
        <?php if ($rwgetRole['doc_expiry_time'] == '1' || $rwgetRole['lock_file'] == '1' || $rwgetRole['doc_weeding_out'] == '1' || $rwgetRole['doc_share_time'] == '1' || $rwgetRole['rename_document'] == '1') { ?>
            <tr>
                ...
                <?php }if ($rwgetRole['doc_share_time'] == '1') { ?>
                    <td>
                        <div class="checkbox checkbox-success">
        ...
        <?php if ($rwgetRole['pdf_print'] == '1' || $rwgetRole['pdf_download'] == '1') { ?>
            <tr>
                <td>
                    <div class="form-group"></div>
                </td>
        ...
        <?php } ?>
        <?php if ($rwgetRole['shared_file'] == '1' || $rwgetRole['share_with_me'] == '1') { ?>
            <tr>
                <td colspan="20"> 
                    <div class="checkbox checkbox-success txt">
            ...
            <tr>
                ...
                <?php if ($rwgetRole['feedback_msg'] == '1') { ?>
                    <td colspan="2">
                        <div class="checkbox checkbox-success">
                            <input id="myCheck60" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_17 col_1" name="fbckmsg" value="1" <?php
                            if ($rwRole['feedback_msg'] == '1') {
                                echo 'checked';
                            }
                            ?>>
            ...
            <tr>
                ...
                <td>
                    <?php if ($rwgetRole['holiday_calender'] == '1') { ?>
                        <div class="checkbox checkbox-success">
                            <input id="myCheck601k" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_20 col_4" name="holidaycal" value="1" <?php
                            if ($rwRole['holiday_calender'] == '1') {
                                echo 'checked';
                            }
                            ?>>
        ...
        <?php if ($rwgetRole['view_exten'] == '1' || $rwgetRole['add_exten'] == '1' || $rwgetRole['enable_exten'] == '1' || $rwgetRole['delete_exten'] == '1' ) { ?>
                ...
                <tr>
                    ...
                    <?php } if ($rwgetRole['enable_exten'] == '1') { ?>
                        <td>
                            <div class="checkbox checkbox-success">
                    ...
                    <?php } if ($rwgetRole['delete_exten'] == '1') { ?>
                        <td>
                            <div class="checkbox checkbox-success">
