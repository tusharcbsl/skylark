...
$childName = mysqli_query($db_con, "select * from tbl_storage_level where sl_parent_id='$parentId' and delete_status=0 ".$where) or die('Error in parent id:' . mysqli_error($db_con));
