...
$childName = mysqli_query($db_con,"select * from tbl_storage_level where sl_parent_id='$parentId' AND sl_id != '$sl_id' and delete_status=0") or die('Error in parent id:'.mysqli_error($db_con));
...
echo' <select class="form-control select21" name="moveToChildId'.$level.'" id="childMoveLevel'.$level.'" style="width:100%;">'
