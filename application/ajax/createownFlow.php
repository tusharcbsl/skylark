...
$id = preg_replace("/[^0-9 ]/", "", $_POST['ID']) + 1;
?>
...
<div id="createTaskFlowr<?php echo $id; ?>">
    ...
    <div class="form-group">
        <a href="javascript:(0)" id="createOwnflowr" class="btn btn-primary" style="margin-top: -90px; margin-left: 915px;" data="<?php echo $id; ?>"><i class="fa fa-plus-circle" title="<?= $lang['Add_more'] ?>"></i></a>
    </div>
