...
// if ($rwgetRole['edit_department'] != '1') {
...
if(!isset($_POST['token'], $_POST['DID'])){
   echo "Unauthrized Access";  
 }
$id = preg_replace("/[^0-9 ]/", "", $_POST['DID']);
mysqli_set_charset($db_con, "utf8");
$department_list = mysqli_query($db_con, "select * from tbl_department where id='$id'");
$rwdepartment = mysqli_fetch_assoc($department_list);
...
<div class="row"> 
    <div class="col-md-12"> 
        <div class="form-group">
            ...
            <input type="text" name="department_name" autocomplete="off" required class="form-control translatetext" id="groupName" value="<?php echo $rwdepartment['department_name']; ?>">
        </div>
    </div> 

</div>                                                    

<input type="hidden" name="did" value="<?php echo $rwdepartment['id']; ?>">
