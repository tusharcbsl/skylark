    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <?php
                if (
                    $rwgetRole['create_user'] == '1' || $rwgetRole['modify_userlist'] == '1' ||
                ...
                ?>
                    <li class="has_sub">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <!-- <li class="nav-item">
                                <a href="item_contract" class="nav-link"><i class="fa fa-hourglass-start" aria-hidden="true"></i> Railway Item No</a>
                            </li> -->
                            <!--authorization end-->
                            <?php if ($rwgetRole['view_department'] == '1') { ?>
                                <li><a href="department"><i class="fa fa-user-plus"></i><?php echo $lang['add_department']; ?></a></li>
                            <?php } ?>
                ...
                <?php if ($rwgetRole['create_storage'] == '1' || $rwgetRole['create_child_storage'] == '1' || $rwgetRole['upload_doc_storage'] == '1' || $rwgetRole['modify_storage_level'] == '1' || $rwgetRole['delete_storage_level'] == '1' || $rwgetRole['move_storage_level'] == '1' || $rwgetRole['copy_storage_level'] == '1') { ?>
                    ...
                    <?php if ($rwgetRole['bulk_upload'] == '1' || $rwgetRole['folder_upload'] == '1') { ?>
                        <li class="has_sub"><a href="#"><i class="md md-cloud-upload"></i> <span><?php echo $lang['Upload_Import']; ?></span> <span class="menu-arrow"></span></a>
                            <ul>
                                ...
                                ?>
                                    <li class="has_sub"><a href="upload-no-of-pages"><i class="fa fa-upload"></i> <span> Upload no of pages</span></a>
                                    <?php
                                }
                                    ?>
                    ...
                    <?php
                    if (
                        $rwgetRole['create_workflow'] == '1' || $rwgetRole['view_workflow_list'] == '1' ||
                        ...
                        <li class="has_sub">
                            ...
                            <ul>
                                ...
                                <?php if ($rwgetRole['workflow_initiate_file'] == '1') { ?>
                                    <!-- <li class="nav-item">
                                        <a href="request_form" class="nav-link"><i class="fa fa-hourglass-start" aria-hidden="true"></i> Request Form</a>
                                    </li> -->
                    ...
                    <?php if ($rwgetRole['view_user_audit'] == '1' || $rwgetRole['view_storage_audit'] == '1' || $rwgetRole['workflow_audit'] == '1') { ?>
                        ...
                        <!-- <li class="has_sub">
                            <a href="raipur.php" class="waves-effect"><i class="fa fa-bars"></i><span>RPP Letter</span> <span class="menu-arrow"></span></a>
                        </li> -->
                    ...
                    <?php if ($rwgetRole['view_recycle_bin'] == '1' || $rwgetRole['restore_file'] == '1' || $rwgetRole['permanent_del'] == '1') { ?>
                        ...
                        <!-- <?php if ($rwgetRole['share_with_me'] == '1' || $rwgetRole['shared_file'] == '1' || $rwgetRole['shared_folder_with_me'] == '1' || $rwgetRole['share_folder'] == '1') { ?>
							...
							<li class="has_sub"><a href="#"><i class="fa fa-share"></i> <span><?php echo $lang['share_files_and_folder']; ?></span> <span class="menu-arrow"></span></a>
								...
								<?php }
                                    if ($rwgetRole['shared_folder_with_me'] == '1') { ?>  
                        ...
                        <li class="has_sub"><a href="#"><i class="fa fa-share"></i> <span><?php echo $lang['share_files_and_folder']; ?></span> <span class="menu-arrow"></span></a>
                            <ul>
                                ...
                                ?>
                                    <li class="has_sub">
                                        <a href="shared-with-me"><i class="fa fa-sign-in" aria-hidden="true"></i><span> <?php echo $lang['Shared_With_Me']; ?></span></a>
                                    </li>
                                <?php
                                }
                                if ($rwgetRole['shared_file'] == '1') { ?>
                                ...
                                if ($rwgetRole['shared_with_me_splt'] == '1') {
                                ?>
                                    <li class="has_sub">
                                        <a href="shared-with-me-splt"><i class="fa fa-sign-in" aria-hidden="true"></i><span> <?php echo 'Splited Shared with me'; ?></span></a>
                                    </li>
                                <?php
                                }

                                if ($rwgetRole['shared_files_splt'] == '1') {
                                ?>
                                    <li class="has_sub">
                                        <a href="shared-files-splt"><i class="fa fa-sign-out" aria-hidden="true"></i><span> <?php echo "Splited File Shared"; ?></span></a>
                                    </li>
                                <?php
                                }
                                ?>
