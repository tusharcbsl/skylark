...
<html>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <ol class="breadcrumb">
                                    <li>
                                        <a href="shared-with-me"><?php echo $lang['list_share_folder']; ?></a>
                                    </li>
                            ...
                            <div class="box box-primary">
                                <div class="panel-body">
                                   ...
                                   $searchTxt ="";
                                    ...
                                    $where = "WHERE fs.share_with='$loginUser'";
                                    ...
                                    $ShDocId = mysqli_query($db_con, "SELECT fs.*, sl.sl_name, u.first_name, u.last_name FROM `tbl_folder_share` as fs inner join tbl_storage_level as sl on fs.slId=sl.sl_id left join tbl_user_master as u  on fs.share_by=u.user_id $where"); //or die('Error in share with id fetch' . mysqli_error($db_con));
	...
	mysqli_set_charset($db_con,"utf8");	                                                $ShDocId = mysqli_query($db_con, "SELECT fs.*, sl.sl_name, u.first_name, u.last_name FROM `tbl_folder_share` as fs inner join tbl_storage_level as sl on fs.slId=sl.sl_id left join tbl_user_master as u  on fs.share_by=u.user_id where fs.share_with='$loginUser'"); //or die('Error in share id fetch' . mysqli_error($db_con));
                                                ...
                                                <table class="table table-striped table-bordered js-sort-table">
                                                    ...
                                                    <?php
                                                    if (isset($_GET['shared_doc']) && !empty($_GET['shared_doc'])) {
                                                        echo '<tr><td colspan="4"><label style="font-weight:600; color:red; margin-left: 440px;"><label><strong class="text-danger"><i class="ti-face-sad text-pink"></i> ' . $lang['Who0ps!_No_Records_Found'] . '</strong></label></td></tr>';
                                                    } else {
                                                        echo '<tr><td colspan="4"><label style="font-weight:600; color:red; margin-left: 440px;">' . $lang['Yu_Hv_No_Shred_Folder'] . '</label></td></tr>';
                                                    }
                                                }
                                                ?> 
                                            </table>
