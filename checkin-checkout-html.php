...
if ($CheckinCheckout == '0') {
            ...
            <div class="comment-list-container">
                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12 m-b-15">
                                        <?php if ($rwgetMetaName['data_type'] == 'datetime') {
                                            ...
                                            <div class="input-group date">
                                                <input type="text" class="form-control datetimepicker" name="fieldName<?php echo $i; ?>" placeholder="DD-MM-YYYY HH:MM" value="<?php
                                        ...
                                        <?php } else if ($rwgetMetaName['data_type'] == 'varchar' || $rwgetMetaName['data_type'] == 'char') {
                                            ?>
                                            <input type="text" id="metaData<?php echo $i; ?>" class="translatetext form-control <?= $rwgetMetaName['data_type'] ?> " name="fieldName<?php echo $i; ?>"  <?= $rwgetMetaName['data_type'] == 'varchar' ? 'pattern="[a-zA-Z0-9@.-\s]+"' : 'pattern="[a-zA-Z\s]+"' ?> value="<?php echo $rwMeta[$rwgetMetaName['field_name']]; ?>" <?php
                                            if ($rwgetMetaName['mandatory'] == "Yes") {
                                                echo "required";
                                            }
                                            ...
                                            ?> maxlength="<?= isset($rwgetMetaName['length_data']) ? "$rwgetMetaName[length_data]" : '' ?>" >
                                                ...
                                                <?php } elseif ($rwgetMetaName['data_type'] == 'boolean') { ?>
                                                   ...
                                                   ?>
                                            <input class="form-control intvl translatetext" id="metaData<?php echo $i; ?>" name="fieldName<?php echo $i; ?>" type="text" value="<?php echo $rwMeta[$rwgetMetaName['field_name']]; ?>"   <?php
                    ...
                    <?php if ($rwgetRole['update_file'] == '1') { ?>
                        <div class="form-group">
                            <div class="col-md-12">
                                <input class="form-control" id="myImage1" name="fileName" type="file">
                    ...
                    <?php } ?>
                    <div class="row">
                        <div class="col-md-12 m-t-15 m-l-15">
                            <button type="submit" name="editMetaValue"  class="btn btn-primary"><?php echo $lang['Submit']; ?></button>
                        </div>
    ...
    <!--<link href="assets/bootstrap-datetimepicker.css" rel="stylesheet">-->
