...
$status = 0;
$checkfileLockqry = mysqli_query($db_con, "SELECT * FROM `tbl_locked_file_master` WHERE doc_id='$id1' and is_active='1' and user_id='$_SESSION[cdes_user_id]'");
if (mysqli_num_rows($checkfileLockqry) > 0) {
    $checkfileLock = mysqli_query($db_con, "SELECT * FROM `tbl_locked_file_master` WHERE doc_id='$id1' and is_locked='1' and user_id='$_SESSION[cdes_user_id]'");
    ...
    if ($ectns[1] != "html") {
        ...
        <html dir="ltr" mozdisallowselectionprint moznomarginboxes>
            <head>
                ...
                <?php require_once"./viewer-pdf/viewerjsdoc.php"; ?>
                <script>
                            ...
                            <div id="toolbarContainer">
                                <div id="toolbarViewer">
                                    ...
                                    <div id="toolbarViewerRight">
                                        ...
                                        <button id="download" class="toolbarButton download hiddenMediumView" title="Download" docname="<?php echo $zlocalpath; ?>" tabindex="-1" data-l10n-id="download" <?php
                                        if ($rwgetRole['pdf_download'] == '1') {
...
//}
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-danger  pull-left" data-dismiss="modal" id="cls">Close</button>
            ...
            <script>
                // doc id for time log
                var doc_id = "<?php echo urlencode(base64_encode($id1)); ?>";
                                                        ...
                                                        <div class="ctext-wrap">
                                                            <span style="float:left;"> <?php
                                                                if (!empty($rwcomment['action_name'])) {
                                                                    echo '<p><strong>' . $lang['Action'] . ' : </strong>' . $rwcomment['action_name'] . '</p>';
                                                                }
                                                                ?> </span> <div class="clearfix"></div>
                                                            <span style="float:right;">
                                                                <p><?php echo '<strong>' . $lang['action_by'] . ' : </strong>' . $rwUsr['first_name'] . ' ' . $rwUsr['last_name']; ?><p>

                                                                <p><?php echo '<strong>' . $lang['action_time'] . ' : </strong>' . date("j F, Y, H:i", strtotime($rwcomment['start_date'])); ?></p></span>
                                                        </div>
                                                    </div>
