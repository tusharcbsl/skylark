...
// assign doc id
    ...
    if ($_GET['chk'] == "rw") {
        ...
        $file = mysqli_query($db_con, "select doc_name, filename, doc_path, doc_extn, old_doc_name, checkin_checkout from tbl_document_master_for_split_pdf where doc_id='$docId'") or die('error' . mysqli_error($db_con));
    }
