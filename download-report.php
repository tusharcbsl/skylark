                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">MIS DOWNLOAD REPORT</a></li>									
                                    ...
                                    <div class="col-sm-8">
                                        <form method="get">						
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <a href="download-report?db=<?php echo $_GET['db']; ?>&cid=<?php echo $_GET['cid']; ?>" class="btn btn-warning"><i class="fa fa-refresh"></i> Reset</a>
                                        ...
                                        <div id="">
                                            <table class="table table-striped table-bordered" id="datatable">
                                                ...
                                                <tbody>
                                                    ...
                                                    //$uploadrept = mysqli_query($newdbconn, "SELECT sl_name,count(doc_id) as no_of_file,doc_name as sl_id,sum(noofpages) as no_of_pages,dateposted,sum(doc_size) as file_size FROM tbl_document_master as tdm  join tbl_storage_level as tsl on tsl.sl_id=tdm.doc_name group by YEAR(dateposted),month(dateposted), day(dateposted),doc_name order by sl_name asc, dateposted desc") or die("ERROR" . mysqli_error($newdbconn));
                                                    ...
                                                    if ($num > 0) {
                                                        ...
                                                        while ($rowdownload_qry = mysqli_fetch_assoc($download_qry)) {
                                                            ...
                                                            //$dqry = mysqli_query($db_con, "SELECT sum(doc_size) as res FROM `tbl_document_master` WHERE doc_id IN($d_memory) and flag_multidelete='1'");
                                                            // $rowsd = mysqli_fetch_assoc($dqry);
                                                            // $downloadMemory = round($rowsd[res] / (1000 * 1000), 2);
                                                            ?>
                                                            <tr>
                                                                <td><?php echo $i; ?></td>
                                                                <td><?php echo $rowdownload_qry['sl_name']; ?></td>
                                                                <td>
                                                                    <?php
                                                                ...
                                                                <td><?php
                                                                    if (!empty($rowdownload_qry['start_date'])) {
                                                                        echo date("d-m-Y", strtotime($rowdownload_qry['start_date']));
                                                                    }
                                                                    ?>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            <th></th><th><strong>Total</strong></th><th><?php echo $totalFiles ?> </th><th><?php echo $totalPages ?> </th><th><?php echo $totaldocSize; ?></th><th></th>
                                                        </tr>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            <th colspan="6" style="text-align: center;color: red">No file downloaded!</th>
                                                        </tr>
                                                    </tfoot>
                                                    <?php
                                                }
										...
										<div class="panel panel-color panel-danger"> 
											...
											<form action="exportUploadReportmis"  method="post">
												...
												<div class="modal-footer"> 
													 ...
													 <input type="hidden" name="db" value="<?php echo $_GET['db'] ?>">
													 <input type="hidden" name="cid" value="<?php echo $_GET['cid'] ?>">
													 <input type="hidden" name="report_type" value="downloadreport">
