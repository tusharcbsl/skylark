...
<body class="fixed-left">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ol class="breadcrumb">
                                ...
                                <li> <a href="#" data-toggle="modal" data-target="#help-modal" id="helpview" data="2" title="<?= $lang['help']; ?>"><i class="fa fa-question-circle"></i> </a></li>
                            ...
                            <form method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group txt">
                                            <label>
                                                <?php echo $lang['Profls_Permissions']; ?></label>
                                        </div>
                                        <table style="width:100%;">
                                            ...
                                            <!-- code for one  -->
                                            <?php if ($rwgetRole['dashboard_mydms'] == '1' || $rwgetRole['dashboard_mytask'] == '1' || $rwgetRole['dashboard_edit_profile'] == '1' || $rwgetRole['dashboard_query'] == '1' || $rwgetRole['num_of_folder'] == '1' || $rwgetRole['num_of_file'] == '1' || $rwgetRole['memory_used'] == '1' || $rwgetRole['status_wf'] == '1' || $rwgetRole['priority_wf'] == '1' || $rwgetRole['calendar'] == '1' || $rwgetRole['mis_report'] == '1') {
                                            ?>
                                                <tr>
                                                    <td>
                                            ...
                                            <?php if ($rwgetRole['priority_wf'] == '1' || $rwgetRole['calendar_wf'] == '1' || $rwgetRole['user_graph'] == '1' || $rwgetRole['mis_report'] == '1') { ?>
                                                <tr>
                                                    ...
                                                    <?php if ($rwgetRole['mis_report'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck150" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_0 col_11" name="mis_report" value="1">
                                            ...
                                            <?php } ?>
                                            <?php if ($rwgetRole['bulk_upload'] == '1' || $rwgetRole['folder_upload'] == '1' || $rwgetRole['upload_files'] == '1') { ?>
                                                <tr>
                                                    <td>
                                                        <div class="checkbox checkbox-success txt">
                                                ...
                                                <tr>
                                                    ...
                                                    if ($rwgetRole['upload_files'] == '1') { ?>
                                                        <td colspan="2">
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myChecdk1s8" type="checkbox" class="checkBoxClass row_5 col_2" name="bulkUpldfiles" value="1">
                                            ...
                                            <?php } ?>
                                            <?php if ($rwgetRole['delete_metadata'] == '1' || $rwgetRole['save_query'] == '1' || $rwgetRole['subscribe_document'] == '1') { ?>
                                                <tr>
                                                    ...
                                                    <?php if ($rwgetRole['subscribe_document'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myChseck21" type="checkbox" class="checkBoxClass row_6 col_6" name="subscribed" value="1">
                                                                <label for="myCheck"><?php echo $lang['subscribe']; ?></label>
                                                            </div>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                            ...
                                            <?php if ($rwgetRole['create_storage'] == '1' || $rwgetRole['create_child_storage'] == '1' || $rwgetRole['upload_doc_storage'] == '1' || $rwgetRole['modify_storage_level'] == '1') { ?>
                                                <tr>
                                                    ...
                                                    <?php if ($rwgetRole['create_child_storage'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck22" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_7 col_1" name="strgAddChild" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['upload_doc_storage'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck23" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_7 col_2" name="strgUpldDoc" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['modify_storage_level'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck24" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_7 col_3" name="strgModi" value="1">
                                                                <label for="myCheck"><?php echo $lang['Edit'] ?></label>
                                                            </div>
                                                        </td>
                                                    <?php } ?>
                                            ...
                                            <?php } ?>
                                            <?php if ($rwgetRole['delete_storage_level'] == '1' || $rwgetRole['move_storage_level'] == '1' || $rwgetRole['copy_storage_level'] == '1' || $rwgetRole['export_user_perm'] == '1') { ?>

                                                <tr>
                                                    <?php if ($rwgetRole['delete_storage_level'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck25" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_7 col_4" name="strgDelete" value="1">
                                                                <label for="myCheck"><?php echo $lang['Delete'] ?></label>
                                                            </div>
                                                        </td>
                                                    <?php } ?>
                                                    <?php if ($rwgetRole['move_storage_level'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck26" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_7 col_5" name="strgMove" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['copy_storage_level'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck27" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_7 col_6" name="strgCopy" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['export_user_perm'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck24" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_7 col_7" name="export_user_perm" value="1">
                                            ...
                                            <?php if ($rwgetRole['involve_workflow'] == '1' || $rwgetRole['run_workflow'] == '1' || $rwgetRole['add_report'] == '1' || $rwgetRole['view_report'] == '1' || $rwgetRole['update_report'] == '1' || $rwgetRole['delete_report'] == '1') { ?>
                                                ...
                                                <?php if ($rwgetRole['delete_report'] == '1' || $rwgetRole['update_report'] == '1') { ?>
                                                    <tr>
                                                        <td>
                                                            <div class="form-group"></div>
                                                        </td>
                                            ...
                                            <?php if ($rwgetRole['metadata_search'] == '1' || $rwgetRole['metadata_quick_search'] == '1' || $rwgetRole['advance_search'] == '1' || $rwgetRole['view_ocr_list'] == '1') { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    if ($rwgetRole['advance_search'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck38" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_11 col_2" name="advancesearch" value="1">
                                                    ...
                                                    if ($rwgetRole['view_ocr_list'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck3d8" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_11 col_3" name="viewocrlist" value="1">
                                            ...
                                            <?php if ($rwgetRole['lock_folder'] == '1' || $rwgetRole['lock_file'] == '1' || $rwgetRole['doc_weeding_out'] == '1' || $rwgetRole['doc_share_time'] == '1' || $rwgetRole['share_folder'] == '1') { ?>
                                                <tr>
                                            ...
                                            <?php if ($rwgetRole['doc_expiry_time'] == 1 || $rwgetRole['view_ppt_pptx'] == 1 || $rwgetRole['view_csv'] == '1' || $rwgetRole['export_ocr'] == '1' || $rwgetRole['rename_document'] == '1') { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($rwgetRole['view_ppt_pptx'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myChecsak53" type="checkbox" class="checkBoxClass row_12 col_34" name="pptppx" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['view_csv'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myChecsak53" type="checkbox" class="checkBoxClass row_12 col_35" name="view_csv" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['export_ocr'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myChecsak53" type="checkbox" class="checkBoxClass row_12 col_36" name="export_ocr" value="1">
                                                ...
                                                <?php if ($rwgetRole['share_folder'] == '1') { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck61" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_12 col_37" name="share_folder" value="1">
                                            ...
                                            <?php if ($rwgetRole['pdf_download'] == '1' || $rwgetRole['pdf_print'] == '1') { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($rwgetRole['splitpdf'] == '1') { ?>
                                                        <td colspan="2">
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck53" type="checkbox" class="checkBoxClass row_14 col_3" name="splitpdf" value="1">
                                            ...
                                            <?php if ($rwgetRole['view_recycle_storage'] == '1' || $rwgetRole['restore_storage'] == '1' || $rwgetRole['delete_storage'] == '1' || $rwgetRole['rename_storage'] == '1') { ?>
                                                ...
                                                <tr>
                                                    <?php if ($rwgetRole['view_recycle_storage'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck571" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_16 col_4" name="view_recycle_storage" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['restore_storage'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck57" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_16 col_5" name="restore_storage" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['delete_storage'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck58" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_16 col_6" name="delete_storage" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['rename_storage'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck58" type="checkbox" class="checkBoxClass row_16 col_7" name="rename_storage" value="1">
                                            ...
                                            <?php } ?>
                                            <?php if ($rwgetRole['shared_file'] == '1' || $rwgetRole['share_with_me'] == '1' || $rwgetRole['feedback_msg'] == '1' || $rwgetRole['shared_folder'] == 1 || $rwgetRole['shared_folder_with_me']) { ?>
                                                <tr>
                                                    <td colspan="20">
                                                        <div class="checkbox checkbox-success txt">
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($rwgetRole['shared_folder'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck60" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_17 col_2" name="shared_folder" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['shared_folder_with_me'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck60" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_17 col_3" name="shared_folder_with_me" value="1">
                                            ...
                                            if ($rwgetRole['password_policy'] == '1' || $rwgetRole['default_lang_setting'] == '1' || $rwgetRole['doc_exp_setting'] == '1' || $rwgetRole['doc_retention_setting'] == '1' || $rwgetRole['doc_share_setting'] == '1') { ?>
                                                ...
                                                <?php if ($rwgetRole['doc_share_setting'] == '1' || $rwgetRole['login_otp'] == '1' || $rwgetRole['login_captcha'] == '1' || $rwgetRole['login_otp_mobile'] == '1' || $rwgetRole['set_watermark'] == '1') { ?>
                                                    <tr>
                                                        <td>
                                                            <div class="form-group"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if ($rwgetRole['login_otp_mobile'] == '1') { ?>
                                                            <td>
                                                                <div class="checkbox checkbox-success">
                                                                    <input id="myChfeccsk15d10" type="checkbox" class="checkBoxClass row_24 col_7" name="loginmobile" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['set_watermark'] == '1') { ?>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="checkbox checkbox-success">
                                                                    <input id="myChfeccsk15d11" type="checkbox" class="checkBoxClass row_24 col_8" name="setwatermark" value="1">
                                            ...
                                            <?php if ($rwgetRole['view_apikey'] == '1' || $rwgetRole['add_apikey'] == '1' || $rwgetRole['regenerate_apikey'] == '1' || $rwgetRole['delete_apikey'] == '1') { ?>
                                                ...
                                                <tr>
                                                    <?php if ($rwgetRole['view_apikey'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="mydCheck160" type="checkbox" class="checkBoxClass row_26 col_1" name="view_apikey" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['add_apikey'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myChecfek159" type="checkbox" class="checkBoxClass row_26 col_2" name="add_apikey" value="1">
                                                    ...
                                                    if ($rwgetRole['regenerate_apikey'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myChefck159" type="checkbox" class="checkBoxClass row_26 col_3" name="regenerate_apikey" value="1">
                                                    ...
                                                    if ($rwgetRole['delete_apikey'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheeck159" type="checkbox" class="checkBoxClass row_26 col_4" name="delete_apikey" value="1">
                                            ...
                                            <?php if ($rwgetRole['mis_upload_download_report'] == '1') { ?>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <?php if ($rwgetRole['mis_upload_download_report'] == '1') { ?>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myCheck80" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_524 col_0" name="mis_upload_download_report" value="1">
                                                                <label for="myCheck">Client Upload & Download MIS Report</label>
                                                            </div>
                                                        <?php } ?>
                                                    </td>
                                            ...
                                            if ($rwgetRole['email_credential'] == '1' || $rwgetRole['add_email_credential'] == '1' || $rwgetRole['edit_email_credential'] == '1') { ?>
                                                <tr>
                                                    <?php if ($rwgetRole['email_credential'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="mydCdhecck160" type="checkbox" class="checkBoxClass row_29 col_0" name="viewemailcre" value="1">
                                                    ...
                                                    <?php if ($rwgetRole['add_email_credential'] == '1') { ?>
                                                        <td>
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myChecfdxek159" type="checkbox" class="checkBoxClass row_29 col_1" name="addmailcre" value="1">
                                                    ...
                                                    if ($rwgetRole['edit_email_credential'] == '1') { ?>
                                                        <td colspan="2">
                                                            <div class="checkbox checkbox-success">
                                                                <input id="myxChedfck159" type="checkbox" class="checkBoxClass row_29 col_2" name="editemailcre" value="1">
  ...
  <td colspan="4"> 
    <div class="checkbox checkbox-primary txt">
        <input type="checkbox" id="select_row_31"/>
...
<td style="width:150px">
    <div class="checkbox checkbox-primary">
        <input id="myChecfdxek161" type="checkbox" class="checkBoxClass row_31 col_1" name="shared_with_me_splt" value="1">
...
<tr>
    <td colspan="4"> 
        <div class="checkbox checkbox-primary txt">
            <input type="checkbox" id="select_row_32"/>
...
<tr>
    ...
    <td>
        <div class="checkbox checkbox-primary">
            <input id="myChecfdxek161" type="checkbox" class="checkBoxClass row_32 col_1" name="shared_files_splt" value="1">
            <label for="myCheck">Split File</label>
        </div>
    </td>
<td>
    <div class="checkbox checkbox-primary">
        <input id="myChecfdxek161" type="checkbox" class="checkBoxClass row_32 col_1" name="send_split_file" value="1">
  ...
  <?php
        if ($rwgetRole['add_department'] == '1' || $rwgetRole['edit_department'] == '1' || $rwgetRole['view_department'] == '1' || $rwgetRole['delete_department'] == '1') {
        ?>
            <tr>
                <td>
                    <div class="checkbox checkbox-success txt">
                        <input type="checkbox" id="select_row_30" />
                        <label for="myCheck"><?php echo $lang['department_manager']; ?></label>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <?php if ($rwgetRole['add_department'] == '1') { ?>
                    <td>
                        <div class="checkbox checkbox-success">
                            <input id="myCheck5" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_30 col_0" name="addDept" value="1" <?php
                                                                                                                                                                                    if ($rwRole['add_department'] == '1') {
                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                    }
                                                                                                                                                                                    ?>>
                            <label for="myCheck"><?php echo $lang['Add'] ?></label>
                ...
                <?php if ($rwgetRole['edit_department'] == '1') { ?>
                    <td>
                        <div class="checkbox checkbox-success">
                            <input id="myCheck6" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_30 col_1" name="editDept" value="1" <?php
                                                                                                                                                                                        if ($rwRole['edit_department'] == '1') {
                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                        }
                                                                                                                                                                                        ?>>
                            <label for="myCheck"><?php echo $lang['Edit'] ?></label>
                ...
                <?php if ($rwgetRole['delete_department'] == '1') { ?>
                    <td>
                        <div class="checkbox checkbox-success">
                            <input id="myCheck7" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_30 col_2" name="deleteDept" value="1" <?php
                                                                                                                                                                                        if ($rwRole['delete_department'] == '1') {
                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                        }
                                                                                                                                                                                        ?>>
                            <label for="myCheck"><?php echo $lang['Delete'] ?></label>
                ...
                <?php } ?>
                <?php if ($rwgetRole['view_department'] == '1') { ?>
                    <td>
                        <div class="checkbox checkbox-success">
                            <input id="myCheck8" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_30 col_3" name="viewDept" value="1" <?php
                                                                                                                                                                                        if ($rwRole['view_department'] == '1') {
                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                        }
                                                                                                                                                                                        ?>>
                            <label for="myCheck"><?php echo $lang['view'] ?></label>
        ...
        <?php
        if ($rwgetRole['view_raipur_letter'] == '1') {
        ?>
            <tr>
                <td>
                    <div class="checkbox checkbox-success txt">
                        <input type="checkbox" id="select_row_33" />
                        <label for="myCheck"><?php echo $lang['raipur_letter']; ?></label>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <?php if ($rwgetRole['view_raipur_letter'] == '1') { ?>
                    <td>
                        <div class="checkbox checkbox-success">
                            <input id="myCheck8" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_33 col_3" name="viewRpp_letter" value="1" <?php
                                                                                                                                                                                        if ($rwRole['view_raipur_letter'] == '1') {
                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                        }
                                                                                                                                                                                        ?>>
                            <label for="myCheck"><?php echo $lang['view'] ?></label>
        ...
        <?php } ?>
        <?php
        if ($rwgetRole['view_raipur_report'] == '1') {
        ?>
            <tr>
                <td>
                    <div class="checkbox checkbox-success txt">
                        <input type="checkbox" id="select_row_34" />
                        <label for="myCheck"><?php echo $lang['raipur_report']; ?></label>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <?php if ($rwgetRole['view_raipur_report'] == '1') { ?>
                    <td>
                        <div class="checkbox checkbox-success">
                            <input id="myCheck8" type="checkbox" data-parsley-multiple="groups" data-parsley-mincheck="2" class="checkBoxClass row_34 col_3" name="viewRpp_report" value="1" <?php
                                                                                                                                                                                        if ($rwRole['view_raipur_report'] == '1') {
                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                        }
                                                                                                                                                                                        ?>>
                            <label for="myCheck"><?php echo $lang['view'] ?></label>
        ...
        if (isset($_POST['addRole'], $_POST['token'])) {
            ...
            if (!empty($_POST['viewRpp_letter'])) {
                $viewRpp_letter = 1;
            } else {
                $viewRpp_letter = 0;
            }
            if (!empty($_POST['viewRpp_report'])) {
                $viewRpp_report = 1;
            } else {
                $viewRpp_report = 0;
            }
            ...
            //For MIS Report
            if (!empty($_POST['mis_upload_download_report'])) {
                $mis_upload_download_report = $_POST['mis_upload_download_report'];
            } else {
                $mis_upload_download_report = 0;
            }
            ...
            $shared_with_me_splt = ((!empty($_POST['shared_with_me_splt'])) ? 1 : 0);
            $shared_files_splt = ((!empty($_POST['shared_files_splt'])) ? 1 : 0);
            $send_split_file = ((!empty($_POST['send_split_file'])) ? 1 : 0);
            $shared_with_me = ((!empty($_POST['shared_with_me'])) ? 1 : 0);
            $shared_files = ((!empty($_POST['shared_files'])) ? 1 : 0);
            //for rename document files
            $File_Rename = ((!empty($_POST['renmdocument'])) ? 1 : 0);
            //for multiple rename document files
            $File_multi_Rename = ((!empty($_POST['multirenmdocument'])) ? 1 : 0);
            ...
            $view_apikey = ((!empty($_POST['view_apikey'])) ? 1 : 0);
            $add_apikey = ((!empty($_POST['add_apikey'])) ? 1 : 0);
            $regenerate_apikey = ((!empty($_POST['regenerate_apikey'])) ? 1 : 0);
            $delete_apikey = ((!empty($_POST['delete_apikey'])) ? 1 : 0);
            //for advance search and ocr list
            $advancesearch = ((!empty($_POST['advancesearch'])) ? 1 : 0);
            $viewocrlist = ((!empty($_POST['viewocrlist'])) ? 1 : 0);
            $splitpdf = ((!empty($_POST['splitpdf'])) ? 1 : 0);
            $subscribed = ((!empty($_POST['subscribed'])) ? 1 : 0);
            $pptppx = ((!empty($_POST['pptppx'])) ? 1 : 0);


            $view_recycle_storage = ((!empty($_POST['view_recycle_storage'])) ? 1 : 0);
            $delete_storage = ((!empty($_POST['delete_storage'])) ? 1 : 0);
            $restore_storage = ((!empty($_POST['restore_storage'])) ? 1 : 0);
            $rename_storage = ((!empty($_POST['rename_storage'])) ? 1 : 0);
            $view_csv = ((!empty($_POST['view_csv'])) ? 1 : 0);

            //email credential
            $viewemailcre = ((!empty($_POST['viewemailcre'])) ? 1 : 0);
            $addemailcre = ((!empty($_POST['addmailcre'])) ? 1 : 0);
            $editemailcre = ((!empty($_POST['editemailcre'])) ? 1 : 0);
            $export_ocr = ((!empty($_POST['export_ocr'])) ? 1 : 0);
            $bulkUpldfiles = ((!empty($_POST['bulkUpldfiles'])) ? 1 : 0);


            $export_user_perm = ((!empty($_POST['export_user_perm'])) ? 1 : 0);
            $loginwithmobile = ((!empty($_POST['loginmobile'])) ? 1 : 0);
            $setwatermark = ((!empty($_POST['setwatermark'])) ? 1 : 0);

            $share_folder = ((!empty($_POST['share_folder'])) ? 1 : 0);
            $shared_folder = ((!empty($_POST['shared_folder'])) ? 1 : 0);
            $shared_folder_with_me = ((!empty($_POST['shared_folder_with_me'])) ? 1 : 0);
            ...
            if (mysqli_num_rows($rolevalidate) >= 1) {
                ...
                $insertRole = mysqli_query($db_con, "insert into tbl_user_roles (user_role, dashboard_mydms, dashboard_mytask,"
                    ...
                    . "priority_wf,calendar_wf,user_graph,mis_report,export_user,import_user,user_activate_deactivate,"
                    ...
                    . "doc_share_time, doc_expiry_time, folder_upload, rename_file,login_otp, view_exten, add_exten, enable_exten, delete_exten, login_captcha, view_apikey, add_apikey, regenerate_apikey, delete_apikey, advance_search, view_ocr_list,mis_upload_download_report, splitpdf, subscribe_document, view_ppt_pptx, view_recycle_storage, delete_storage, restore_storage, rename_storage, view_csv, email_credential, add_email_credential, edit_email_credential, export_ocr, upload_files, export_user_perm, login_otp_mobile, set_watermark, share_folder, shared_folder, shared_folder_with_me,rename_document,Multi_rename_document,shared_with_me_splt, shared_files_splt, send_split_file, add_department, edit_department, view_department, delete_department, view_raipur_letter, view_raipur_report) values ('$roleName','$mydms','$mytsk','$dashEditPro','$dashQury','$usrAdd',"
                    ...
                    . "'$clabel','$deluserlog', '$delstrglog', '$delwflog','$status', '$priority', '$calendar','$user_graph','$mis_report','$export_user',"
                    ...
                    . "'$lock_file', '$lock_folder', '$doc_weeding_out', '$doc_share_time', '$doc_expiry_time', '$folder_upload', '$renamefile', '$emailotp', '$view_exten','$add_exten','$enable_exten','$delete_exten', '$login_captcha', '$view_apikey',"
                    . " '$add_apikey', '$regenerate_apikey', '$delete_apikey', '$advancesearch', '$viewocrlist','$mis_upload_download_report', '$splitpdf', '$subscribed', '$pptppx', '$view_recycle_storage', '$delete_storage', '$restore_storage', '$rename_storage', '$view_csv', '$viewemailcre', '$addemailcre', '$editemailcre', '$export_ocr', '$bulkUpldfiles', '$export_user_perm', '$loginwithmobile', '$setwatermark', '$share_folder', '$shared_folder', '$shared_folder_with_me','$File_Rename','$File_multi_Rename','$shared_with_me_splt','$shared_files_splt','$send_split_file','$addDept','$editDept','$viewDept','$deleteDept', '$viewRpp_letter', '$viewRpp_report')") or die('Error: dd' . mysqli_error($db_con));
        ...
        if (isset($_POST['editRole'], $_POST['token'])) {
            ...
            if (mysqli_num_rows($rolevalidate) >= 1) {
                ...
                $edit = mysqli_query($db_con, "update tbl_user_roles set user_role='$roleName', dashboard_mydms='$mydms',dashboard_mytask='$mytsk',"
                    ...
                    . "user_graph='$user_graph', mis_report='$mis_report',"
                    ...
                    . "doc_weeding_out='$doc_weeding_out', doc_share_time='$doc_share_time', doc_expiry_time='$doc_expiry_time', folder_upload='$folder_upload', rename_file='$renamefile', login_otp='$emailotp', view_exten='$view_exten', add_exten='$add_exten', enable_exten='$enable_exten', "
                    . "delete_exten='$delete_exten', login_captcha='$login_captcha', view_apikey='$view_apikey', add_apikey='$add_apikey', regenerate_apikey='$regenerate_apikey', delete_apikey='$delete_apikey',advance_search='$advancesearch', view_ocr_list='$viewocrlist',mis_upload_download_report='$mis_upload_download_report', splitpdf='$splitpdf',  subscribe_document='$subscribed', view_ppt_pptx='$pptppx', view_recycle_storage='$view_recycle_storage', delete_storage='$delete_storage', restore_storage='$restore_storage', rename_storage='$rename_storage', view_csv='$view_csv', email_credential='$viewemailcre', add_email_credential='$addemailcre', edit_email_credential='$editemailcre', export_ocr='$export_ocr', upload_files='$bulkUpldfiles', export_user_perm='$export_user_perm', login_otp_mobile='$loginwithmobile', set_watermark='$setwatermark', share_folder='$share_folder', shared_folder='$shared_folder', shared_folder_with_me='$shared_folder_with_me',rename_document='$File_Rename',Multi_rename_document='$File_multi_Rename' ,shared_with_me_splt='$shared_with_me_splt',shared_files_splt='$shared_files_splt',send_split_file='$send_split_file', add_department='$addDept', edit_department='$editDept', view_department='$viewDept', delete_department='$deleteDept', view_raipur_letter='$viewRpp_letter', view_raipur_report = '$viewRpp_report' where role_id='$rid'") or die('Error : ' . mysqli_error($db_con));
                if ($edit) {
                    $id = $rid;
                    $flag = 0;
                    $groups = $_POST['groups'];
