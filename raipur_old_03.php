    ...
    if(!empty($dept_id)){
        ...
        if (empty($errors)) {
            ...
            foreach ($details as $index => $detail) {
                ...
                $insertStmt->bind_param("sssssssssssss", $fileExtension, $sl_idNew, $detail, $desc, $noofpages, $doc_size, $name, $_SESSION['cdes_user_id'], $name, $name, $dept_id, $flag_folder, $sent_by);
            ...
            // $emailList = [];
            $emailList = ['tusharbindal297@gmail.com', 'tusharbindal754@gmail.com'];
            // $result = mysqli_query($db_con, "SELECT user_email_id,user_id FROM tbl_user_master WHERE dept_id = '$dept_id'");
