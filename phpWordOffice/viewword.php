...
$id1 = base64_decode(urldecode($_GET['file'])); //doc_id
...
if ($ectns[1] != "html") {
      ...
      $converter = new OfficeConverter($localPath,"TEMP");
...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
    <head>
        ...
        <script src="../viewer-pdf/build/pdf.worker.js"></script>
            ...
            <div id="mainContainer">
                ...
                <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
                    <div id="secondaryToolbarButtonContainer">
                        ...
                        <button id="secondaryPrint" class="secondaryToolbarButton print visibleMediumView" title="Print" tabindex="53" data-l10n-id="print" <?php if ($rwgetRole['pdf_print'] == '1') { }else{echo'disabled';}?>>
                         <span data-l10n-id="print_label">Print</span>
                        </button>
                      
                        <button id="secondaryDownload" class="secondaryToolbarButton download visibleMediumView" title="Download" tabindex="54" data-l10n-id="download" <?php if ($rwgetRole['pdf_download'] == '1') { }else{echo'disabled';}?>>
                        ...
                        <div id="toolbarViewer">
                            ...
                            <div id="toolbarViewerRight">
                                ...
                                <button id="openFile" class="toolbarButton openFile hiddenLargeView" title="Open File" tabindex="32" data-l10n-id="open_file" disabled>
                                    ...
                                    <button id="print1" class="toolbarButton print hiddenMediumView" title="Print" tabindex="33" data-l10n-id="print" <?php if ($rwgetRole['pdf_print'] == '1') { }else{echo'disabled';}?>>
                                        <span data-l10n-id="print_label">Print</span>
                                    </button>
                                  <button id="download" class="toolbarButton download hiddenMediumView" title="Download" tabindex="-1" data-l10n-id="download" <?php if ($rwgetRole['pdf_download'] == '1') { }else{echo'disabled';}?>>
                                    <span data-l10n-id="download_label">Download</span>
                                </button>
...
<html>
    ...
    <body>
        <div class="container-fluid" style="background-color: #006dcc;">
            <div class="jumbotron" style="padding-top: 1px;padding: 1px">
                <center><p><?= $doc_old_name . "." . $doc_extn ?></p></center>

            </div>
            <div class="col-md-2" style="background-color: #006dcc;height: 100%">

            </div>
            <div class="col-md-8 " style="background-color: whitesmoke;height: 100%">
                ...
                <div id="comment-wrapper">
                    ...
                    <div class="comment-list">
                        <div class="comment-list-container">
                            ...
                            <div id="comentAdd">
                                <?php
                                $docReview = mysqli_query($db_con, "select * from `tbl_reviews_log` where doc_id='$id1' order by id asc");
                                                    ...
                                                    <div class="ctext-wrap">
                                                        <span style="float:left;">   <?php
                                                            if (!empty($rwcomment['action_name'])) {
                                                                echo '<strong>Review: </strong>' . $rwcomment['action_name'] . '<br>';
                                                            }
                                                        ...
                                                        <span style="float:right;">
                                                            ...
                                                            <br/>
                                                            <?php echo date("j F, Y, H:i", strtotime($rwcomment['start_date'])); ?></span>
                                                    </div>
                                                </div>
                                            </li>
                                        </div>
