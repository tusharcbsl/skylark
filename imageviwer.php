                            ...
                            <div id="toolbarViewer">
                                <div id="toolbarViewerRight" class="pull-right">
                                    <?php if ($rwgetRole['pdf_print'] == '1') { ?>
                                        <button id="btnPrint" class="btn btn-default btn-lg" title="Print">
                                            <span class="glyphicon glyphicon-print"></span>
                                        </button>
                                    <?php } ?>
                                    <?php if ($rwgetRole['pdf_download'] == '1') { ?>
                                        <a href="<?php echo $localPath; ?>" id="down" class="btn btn-default btn-lg" title="Download" download> <span class="glyphicon glyphicon-download-alt"></span> </a>
                                    <?php } ?>
