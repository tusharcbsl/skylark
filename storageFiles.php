                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        if ($foundnum > 0) {
                                            ...
                                            $allot = "select * from tbl_document_master $where order by dateposted DESC LIMIT $start, $per_page";
                                                ...
                                                <table class="table table-striped table-bordered js-sort-table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <?php if(base64_decode($_GET['id']) == storage_rfi_id){ ?>
                                                                <th><?php echo $lang['description_work']; ?></th>
                                                            <?php } ?>
                                                            <!-- <th class="js-sort-none"><?php echo $lang['Attachments']; ?></th> -->
                                                        ...
                                                        ?>
                                                            <?php if ((!empty($weed) && !empty($weedTile)) && (!empty($docexpcolor) && !empty($expiryTitle))) { ?>
                                                                ...
                                                                <?php if(base64_decode($_GET['id']) == storage_rfi_id){ ?>
                                                                    <td>
                                                                        <?php
                                                                        $queryyy = "SELECT * FROM tbl_railway_master WHERE ticket_id='" . $file_row['ticket_id'] . "'";
                                                                        ...
                                                                        if ($railway_result && mysqli_num_rows($railway_result) > 0) {
                                                                            ...
                                                                            echo ucfirst($railway_row['description_of_work']);
                                                                        } else {
                                                                            echo "";
                                                                        }
                                                                        ?>
                                                                ...
                                                                <?php } ?>
                                                                    ...
                                                                    <!-- <td>
                                                                    <?php
                                                                    $queryyy = "SELECT * FROM tbl_railway_attachment_master WHERE ticket_id='" . $file_row['ticket_id'] . "'";
                                                                    // print_r($queryyy);
                                                                    $resultt = mysqli_query($db_con, $queryyy);
                                                                    if ($resultt->num_rows > 0) {
                                                                        while ($myattachment = mysqli_fetch_assoc($resultt)) {                                                                                                                                     ?>
                                                                            <a href="uploads/<?php echo htmlspecialchars($myattachment['attachment']); ?>" target="_blank">
