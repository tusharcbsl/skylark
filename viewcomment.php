...
$id1 = base64_decode(urldecode($_GET['id']));  // comment id
//$id = base64_decode(urldecode($_GET['id']));  //doc asign id
//$id1=55;
$file = mysqli_query($db_con, "select * from tbl_task_comment where id='$id1'") or die('error' . mysqli_error($db_con));

$rwFile = mysqli_fetch_assoc($file);
$fileName = pathinfo($rwFile['comment']);
