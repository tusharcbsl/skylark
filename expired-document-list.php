                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <ol class="breadcrumb">
                                    <li>
                                        <a href="expired-document-list"><?php echo $lang['expired_doc_list']; ?></a>
                                    </li>
                                    ...
                                    <?php if (!empty($slids)) { ?>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <form method="get">
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control translatetext" name="expdoc" id="expdoc" value="<?php echo xss_clean(trim($_GET['expdoc'])); ?>" parsley-trigger="change"  placeholder="<?php echo $lang['Search']; ?>" required />
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <button type="submit" class="btn btn-primary"><?php echo $lang['Search']; ?> <i class="fa fa-search"></i> </button>
                                                        <a href="expired-document-list" class="btn btn-warning"> <?php echo $lang['Reset']; ?></a>
                                                    </div>
                                                </form>
                                        ...
                                        if (isset($_GET['expdoc']) && !empty($_GET['expdoc'])) {
                                            $deleteFile = trim($_GET['expdoc']);
                                        ...
                                        if ($foundnum > 0) {
                                            ...
                                            <div class="container">
                                                ...
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $docexp = mysqli_query($db_con, "SELECT * FROM `tbl_document_master` $where order by old_doc_name LIMIT $start, $per_page") or die('Error:' . mysqli_error($db_con));
                                                        if (isset($start) && $start != 0) {
                                                            $i = $start + 1;
                                                        } else {
                                                            $i = 1;
                                                        }
                                                        while ($rwdocexp = mysqli_fetch_assoc($docexp)) {
                                                            $getSlName = mysqli_query($db_con, "select sl_name from tbl_storage_level where sl_id = '$rwdocexp[doc_name]'") or die('Error in get name' . mysqli_error($db_con));
                                                            $rwgetSlName = mysqli_fetch_assoc($getSlName);
                                                            $existfile = mysqli_query($db_con, "select old_doc_name,doc_name from tbl_document_master where old_doc_name='$rwdocexp[old_doc_name]' and doc_name='$rwdocexp[doc_name]' and flag_multidelete='1'");
                                                            ...
                                                            <tr class="gradeX">
                                                                ...
                                                                <td style="width:450px;">
                                                                    ...
                                                                    echo $rwdocexp['old_doc_name'];
                                                                    if ($rwdocexp['checkin_checkout'] == '1') {
                                                                        $file_row = $rwdocexp;
                                                                ...
                                                                <td><?php echo date('d-m-Y H:i:s ', strtotime($rwdocexp['doc_expiry_period'])); ?></td>
                                                                <td><?php echo strtolower($rwdocexp['doc_extn']); ?></td>
                                                                <td><?php echo $rwgetSlName['sl_name']; ?></td>
                                                                <td><?php echo round($rwdocexp['doc_size'] / (1000 * 1000), 2); ?> MB</td>
                                                ...
                                                if ($max_pages > 1) {
                                                    ...
                                                    <ul class='pagination strgePage'>
                                                        ...
                                                        //previous button
                                                        if (!($start <= 0))
                                                            echo " <li><a href='?start=$prev&limit=$per_page&expdoc=$_GET[expdoc]'>$lang[Prev]</a> </li>";
                                                        else
                                                        ...
                                                        if ($max_pages < 7 + ($adjacents * 2)) {   //not enough pages to bother breaking it up
                                                            ...
                                                            for ($counter = 1; $counter <= $max_pages; $counter++) {
                                                                if ($i == $start) {
                                                                    echo " <li class='active'><a href='?start=$i&limit=$per_page&expdoc=$_GET[expdoc]'><b>$counter</b></a> </li>";
                                                                } else {
                                                                    echo "<li><a href='?start=$i&limit=$per_page&expdoc=$_GET[expdoc]'>$counter</a></li> ";
                                                                }
                                                                $i = $i + $per_page;
                                                            }
                                                            ...
                                                            elseif ($max_pages - ($adjacents * 2) > ($start / $per_page) && ($start / $per_page) > ($adjacents * 2)) {
                                                                echo " <li><a href='?start=0&limit=$per_page&expdoc=$_GET[expdoc]'>1</a></li> ";
                                                                echo "<li><a href='?start=$per_page&limit=$per_page&expdoc=$_GET[expdoc]'>2</a></li>";
                                                        ...
                                                        if (!($start >= $foundnum - $per_page))
                                                            echo "<li><a href='?start=$next&limit=$per_page&expdoc=$_GET[expdoc]'>$lang[Next]</a></li>";
                                                        else
                ...
                <div class="modal-dialog"> 
                    <div class="panel panel-color panel-primary"> 
                        <div class="panel-heading"> 
                            ...
                            <label><h2 class="panel-title"><?php echo $lang['export_expired_document']; ?></h2></label> 
                        </div> 
                        <form action="export-expired-document"  method="post">
                            <div class="panel-body">
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="hidden" value="<?php echo $_GET['expdoc']; ?>" name="expdoc">
