                                ...
                                <form method="post" enctype="multipart/form-data" id="wfform">
                                    ...
                                    <div class="row" id="descp">
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            if ($rwgetWorkflwIdDs['form_req'] == 0 && $rwgetWorkflwIdDs['form_type'] != 1) {
                                                ?>
...
$rfi_query = "SELECT id,rfi_no FROM tbl_railway_master ORDER BY id DESC LIMIT 1";
        ...
        if (mysqli_num_rows($formExistQry) > 0) {
            ...
            if (!empty($_POST['lastMoveId'])) {
                ...
                if (mysqli_num_rows($chkrw) > 0) {
                    ...
                    if ($rwWfd['pdf_req'] == 1 || $rwWfd['form_req'] == 1) {
                        include 'exportpdf.php';
                ...
                if (mysqli_num_rows($chkrw) > 0) {
                    ...
                    if ($rwWfd['form_type'] == 1) {
                        ...
                        $pagecount = count_pages($path);
                        $wrkflowDoc = mysqli_query($db_con, "INSERT INTO tbl_document_master (doc_name, old_doc_name, doc_extn, doc_path, uploaded_by, doc_size, noofpages, dateposted,generated_pdf_doc,ticket_id) VALUES ('$doc_name', '$pdfName', 'pdf', '$folderName/$pdfName', '$user_id', '$wrkflowFsize', '$pagecount', '$date','1','$ticket')") or die('Eror:' . mysqli_error($db_con));
                        $docId = mysqli_insert_id($db_con);
                        // die('qqqql');

                        // $formbuild1 = "<table class='table' border='1' cellspacing='7' width='100%' style='border-collapse: collapse; font-size:12px;'>";
                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td colspan='2' align='center'>" . "<b>" . $row['label'] . "</b>" . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "RFI No" . "</b></td>"; // Corresponds to rfi_no
                        // $formbuild1 .= "<td>" . $_POST['rfi_no'] . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "RFI Date" . "</b></td>"; // Corresponds to rfi_date
                        // $formbuild1 .= "<td>" . date('d-m-Y', strtotime($_POST['rfi_date'])) . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Type Regular" . "</b></td>"; // Corresponds to type_regular
                        // $formbuild1 .= "<td>" . $_POST['type_regular'] . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Contractor Name" . "</b></td>"; // Corresponds to name_of_the_contractor
                        // $formbuild1 .= "<td>" . $_POST['name_of_the_contractor'] . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Item No" . "</b></td>"; // Corresponds to item_no_as_per
                        // $formbuild1 .= "<td>" . $_POST['item_no_as_per'] . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Inspection Required Date" . "</b></td>"; // Corresponds to inspection_required_date
                        // $formbuild1 .= "<td>" . date('d-m-Y', strtotime($_POST['inspection_required_date'])) . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Location From" . "</b></td>"; // Corresponds to location_from
                        // $formbuild1 .= "<td>" . $_POST['location_from'] . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Location To" . "</b></td>"; // Corresponds to location_to
                        // $formbuild1 .= "<td>" . $_POST['location_to'] . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Inspecting Engineer Name" . "</b></td>"; // Corresponds to name_of_the_inspecting_engineer
                        // $formbuild1 .= "<td>" . $_POST['name_of_the_inspecting_engineer'] . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Inspected On Date" . "</b></td>"; // Corresponds to inspected_on_date
                        // $formbuild1 .= "<td>" . date('d-m-Y', strtotime($_POST['inspected_on_date'])) . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Remarks" . "</b></td>"; // Corresponds to remarks_of_the_inspection
                        // $formbuild1 .= "<td>" . $_POST['taskRemark'] . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Approved" . "</b></td>"; // Corresponds to approved
                        // $formbuild1 .= "<td>" . (isset($_POST['approved']) ? 'Yes' : 'No') . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Not Approved" . "</b></td>"; // Corresponds to not_approved
                        // $formbuild1 .= "<td>" . (isset($_POST['not_approved']) ? 'Yes' : 'No') . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Description of Work" . "</b></td>"; // Corresponds to description_of_work
                        // $formbuild1 .= "<td>" . $_POST['description_of_work'] . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Enclosures Attached" . "</b></td>"; // Corresponds to enclosures_attached
                        // $formbuild1 .= "<td>" . $_POST['enclosures_attached'] . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Contractor Signature" . "</b></td>"; // Corresponds to signature_of_the_contractor
                        // $formbuild1 .= "<td>" . $_POST['signature_of_the_contractor'] . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Inspection Signature" . "</b></td>"; // Corresponds to signature_of_the_inspection
                        // $formbuild1 .= "<td>" . $_POST['signature_of_the_inspection'] . "</td>";
                        // $formbuild1 .= "</tr>";

                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<td><b>" . "Date" . "</b></td>"; // Corresponds to date
                        // $formbuild1 .= "<td>" . date('d-m-Y', strtotime($_POST['date'])) . "</td>";
                        // $formbuild1 .= "</tr>";
            ...
            <div class="card-box">
                <div id="dynamicForm">
                    ...
                    <div class="row">
                        ...
                        // $formbuild1 = "<table class='table table-bordered' border='1' cellspacing='7' width='100%' style='border-collapse: collapse; font-size:12px;'>";
                        // $formbuild1 .= "<thead>";
                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<th class='col-md-2' rowspan='2' style='vertical-align:middle; text-align:center;'>";
                        // $formbuild1 .= "<img src='assets/images/rail.JPEG' class='south_railway' alt='Italian Trulli'>";
                        // $formbuild1 .= "</th>";
                        // $formbuild1 .= "<th class='col-md-8' style='text-align:center; font-size:large; vertical-align:middle;'><u>REQUEST FOR INSPECTION (RFI)</u></th>";
                        // $formbuild1 .= "<th class='col-md-2' rowspan='2' style='vertical-align:middle; text-align:center;'>";
                        // $formbuild1 .= "<img src='assets/images/pra1.JPEG' class='south_railway' alt='Italian Trulli'>";
                        // $formbuild1 .= "</th>";
                        // $formbuild1 .= "</tr>";
                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<th class='col-md-8' style='vertical-align:middle; text-align:center;'>";
                        // $formbuild1 .= "Project Doubling of Railway Project comprising the section commencing from(--) Road station (End CH 967.055) to Surajpur Road Station (End CH : 1006.44) (KM-39.385 KM) beside existing single 84 line in the state of Chhattisgarh in the South East Central Railway Zone Agt No: SECR/SECRC/CMI/2024/0008/ dt 14-Mar-2024.";
                        // $formbuild1 .= "</th>";
                        // $formbuild1 .= "<th></th>";
                        // $formbuild1 .= "</tr>";
                        // $formbuild1 .= "</thead>";
                        ...
                        // $formbuild1 .= "<table class='table table-bordered upper'>";
                        // $formbuild1 .= "<thead>";
                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<th class='col-md-6' colspan='3' style='text-align:left; vertical-align:middle;'>Client : South East Central Railway</th>";
                        // $formbuild1 .= "<th class='col-md-6' colspan='3' style='text-align:center; vertical-align:middle;'>Contractor : Barbrik Project Limited</th>";
                        // $formbuild1 .= "</tr>";
                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<th class='col-md-2 top-center' style='text-align:center; vertical-align:middle;'>RFI No</th>";
                        // $formbuild1 .= "<th class='col-md-2 top-center' style='text-align:center; vertical-align:middle;'>RFI Date</th>";
                        // $formbuild1 .= "<th class='col-md-2 top-center' style='text-align:center; vertical-align:middle;'>Type <br> (Regular/Spot)</th>";
                        // $formbuild1 .= "<th class='col-md-2 top-center' style='text-align:center; vertical-align:middle;'>Name Of the Contractor's Engineer offering the work for inspection</th>";
                        // $formbuild1 .= "<th class='col-md-2 top-center' style='text-align:center; vertical-align:middle;'>Item No as per contract <br> (for payment)</th>";
                        // $formbuild1 .= "<th class='col-md-2 top-center' style='text-align:center; vertical-align:middle;'>Inspection Required On</th>";
                        // $formbuild1 .= "</tr>";
                        // $formbuild1 .= "</thead>";
                        // $formbuild1 .= "</table>";
                        ...
                        // $formbuild1 .= "<table class='table table-bordered upper'>";
                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<th class='col-md-2'>" . htmlspecialchars($_POST['rfi_no'] ?? '') . "</th>";
                        // $formbuild1 .= "<th class='col-md-2'>" . htmlspecialchars($_POST['rfi_date'] ?? '') . "</th>";
                        // $formbuild1 .= "<th class='col-md-2'>" . ($_POST['type_regular'] ?? '') . "</th>";
                        // $formbuild1 .= "<th class='col-md-2'>" . htmlspecialchars($_POST['name_of_the_contractor'] ?? '') . "</th>";
                        // $formbuild1 .= "<th class='col-md-2'>" . ($_POST['item_no_as_per'] ?? '') . "</th>";
                        // $formbuild1 .= "<th class='col-md-2'>" . htmlspecialchars($_POST['inspection_required_date'] ?? '') . "</th>";
                        // $formbuild1 .= "</tr>";
                        // $formbuild1 .= "</table>";

                        // $formbuild1 .= "<table class='table table-bordered upper'>";
                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<th class='col-md-2' rowspan='2' colspan='2'>Location / Chainage</th>";
                        // $formbuild1 .= "<th class='col-md-4' rowspan='2'>";
                        // $formbuild1 .= "<div class='col-md-6'>" . htmlspecialchars($_POST['location_from'] ?? '') . "</div>";
                        // $formbuild1 .= "<div class='col-md-6'>" . htmlspecialchars($_POST['location_to'] ?? '') . "</div>";
                        // $formbuild1 .= "</th>";
                        // $formbuild1 .= "<th class='col-md-4' colspan='1' style='text-align:left;'>Name Of the Inspecting Engineer</th>";
                        // $formbuild1 .= "<th class='col-md-2'>" . htmlspecialchars($_POST['name_of_the_inspecting_engineer'] ?? '') . "</th>";
                        // $formbuild1 .= "<th class='col-md-2'>" . htmlspecialchars($_POST['inspected_on_date'] ?? '') . "</th>";
                        // $formbuild1 .= "</tr>";
                        // $formbuild1 .= "</table>";

                        // $formbuild1 .= "<table class='table table-bordered upper'>";
                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<th class='col-md-12' colspan='6'>Request for Inspection of the following works, Which are /will be ready for inspection</th>";
                        // $formbuild1 .= "</tr>";
                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<th class='col-md-3'>1. C&G</th>";
                        // $formbuild1 .= "<th class='col-md-3'>" . (isset($_POST['c_and_g']) ? 'Yes' : 'No') . "</th>";
                        // $formbuild1 .= "<th class='col-md-3'>2. Earthwork</th>";
                        // $formbuild1 .= "<th class='col-md-3'>" . (isset($_POST['earthwork']) ? 'Yes' : 'No') . "</th>";
                        // $formbuild1 .= "</tr>";
                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<th class='col-md-3'>3. Blanketing</th>";
                        // $formbuild1 .= "<th class='col-md-3'>" . (isset($_POST['blanketing']) ? 'Yes' : 'No') . "</th>";
                        // $formbuild1 .= "<th class='col-md-3'>4. Ballast</th>";
                        // $formbuild1 .= "<th class='col-md-3'>" . (isset($_POST['ballast']) ? 'Yes' : 'No') . "</th>";
                        // $formbuild1 .= "</tr>";
                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<th class='col-md-3'>5. Supply of Material</th>";
                        // $formbuild1 .= "<th class='col-md-3'>" . (isset($_POST['supply_of_material']) ? 'Yes' : 'No') . "</th>";
                        // $formbuild1 .= "<th class='col-md-3'>6. Bridge Work</th>";
                        // $formbuild1 .= "<th class='col-md-3'>" . (isset($_POST['bridge_work']) ? 'Yes' : 'No') . "</th>";
                        // $formbuild1 .= "</tr>";
                        // $formbuild1 .= "<tr>";
                        // $formbuild1 .= "<th class='col-md-3'>Remarks of the Inspection Engineer</th>";
                        // $formbuild1 .= "<th class='col-md-3' colspan='3'>" . htmlspecialchars($_POST['remarks'] ?? '') . "</th>";
                        // $formbuild1 .= "</tr>";
                        // $formbuild1 .= "</table>";
