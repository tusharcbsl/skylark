...
//    $files=$_FILES['fileName']['tmp_name'][$i];
//    echo $getcontents=file_get_contents($files);
//    }
    //for user role
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-1" style="width:90%; margin: auto; text-align: center; vertical-align: middle;">
                        <?php
                       ...
                       echo "$taskRemark";
                        ...
                        <form method="post">
                            <?php
                             $wfid = $_POST['wfid'];
                            ?>
                            <input type="hidden" name="wfid" value="<?php echo $wfid;?>">
                            <input type="hidden" name="lastMoveId" value="<?php echo $_POST['lastMoveId'];?>">
                            <textarea type="hidden" name="taskRemark" style="display:none;"><?php echo $taskRemark;?></textarea>
      <?php                      
    $files=$_FILES['fileName']['name'];
    for ($i = 0; $i < count($files); $i++){
    $files=$_FILES['fileName']['tmp_name'][$i];
     ...
     ?>                       <input type="hidden" name="fileName" value="<?php echo $_FILES['fileName']['name'][$i];?>">
     <?php
    }
     ?>
                            <div class="col-md-6">
                            <input type="submit" name="submit" value="submit" class="btn btn-primary pull-right" style="margin-top:10px;">
                            </div>
                        </form>
                        </div>
                        <!-- Page-Title -->
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#dataprev').click(function () {
                    var Remark = $('#editor').text();
                    alert(Remark);
                    $('#viewpreview').val(Remark);
