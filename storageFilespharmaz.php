...
<body class="fixed-left">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <?php if ((!empty($weed) && !empty($weedTile)) && (!empty($docexpcolor) && !empty($expiryTitle))) { ?>
                                                                ...
                                                                <td>
                                                                    <div style="overflow: hidden; max-width:200px;" data-toggle="tooltip" title="<?php echo $file_row['old_doc_name']; ?>"><?php echo $file_row['old_doc_name']; ?></div>
                                                                </td>
                                                                <td><?php
                                                                ...
                                                                <td>
                                                                    <li class="dropdown top-menu-item-xs">
                                                                        ...
                                                                        if (mysqli_num_rows($checkfileLockqry) > 0) {
                                                                            $checkfileLock = mysqli_query($db_con, "SELECT * FROM `tbl_locked_file_master` WHERE doc_id='$file_row[doc_id]' and is_active='1' and user_id='$_SESSION[cdes_user_id]'");
                                                                        ...
                                                                        ?>
                                                                            ...
                                                                            <ul class="dropdown-menu pdf gearbody">
                                                                                ...
                                                                                <?php if ($rwFolder['is_protected'] == 0 || $_SESSION['pass'] == $rwFolder['password']) { ?>
                                                                                    ...
                                                                                    <?php }
                                                                                            if (($rwgetRole['workflow_initiate_file'] == '1' || $rwgetRole['initiate_file'] == '1') && $file_row['doc_expiry_period'] == '' && $file_row['retention_period'] == '') { ?>
                                                                                        <li> <a href="javascript:void(0)" data-toggle="modal" data-target="#assign-workflow" id="moveToWf" data="<?php echo $file_row['doc_id']; ?>"> <i class="fa fa-plus"></i> <?php echo $lang['Workflow']; ?></a></li>
                                                                                    <?php } ?>
                                                                                    <?php if ($rwgetRole['checkin_checkout'] == '1') { ?>
                                                                                        <li><a href="javascript:void(0)" id="checkout" data="<?php echo $file_row['doc_id']; ?>"><i class="fa fa-sign-out"></i> <?php echo $lang['Chk_Out']; ?></a></li>
                                                                ...
                                                                <td colspan="7">
                                                                    <?php if ($rwFolder['is_protected'] == 0 || $_SESSION['pass'] == $rwFolder['password']) { ?>
                                                                        <ul class="delete_export">
                                                                            ...
                                                                            <?php }
                                                                            if ($rwgetRole['share_file'] == '1' && $rwdocshare['docshare_enable_disable'] == '1') { ?>
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="sharewith[]" id="sharewith" class="form-control select2 multi-select" multiple data-placeholder="<?php echo $lang['Select_User']; ?>">
    ...
    <script>
        $("#wfid").change(function() {
            var wfId = $(this).val();
            alert(lbl);
            $.post("application/ajax/workFlstp.php", {
                wid: wfId
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-control select2" data-type="storage" name="moveToParentId" id="parentMoveLevel">

                                    <option selected disabled><?php echo $lang['Sel_Strg_Lvl'] ?></option>

                                    <?php
                                    $storageperm = mysqli_query($db_con, "select sl_id from tbl_storagelevel_to_permission where user_id='" . $_SESSION['cdes_user_id'] . "'") or die('Error in move store: ' . mysqli_error($db_con));
                                    while ($rwstorageperm = mysqli_fetch_assoc($storageperm)) {
                                        mysqli_set_charset($db_con, "utf8");
                                        $storeName = mysqli_query($db_con, "select * from tbl_storage_level where sl_id='$rwstorageperm[sl_id]'") or die('Error in move store: ' . mysqli_error($db_con));
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control select2" data-type="storage" name="moveToParentId" id="parentCopyLevel">
    ...
    if (isset($_POST['move'], $_POST['token'])) {
        ...
        if (!empty($_POST['lastMoveId'])) {
            ...
            if (mysqli_num_rows($sql_child_run)) {
                ...
                mysqli_set_charset($db_con, "utf8");
                $moveToId = preg_replace("/[^A-Za-z0-9 ]/", "", $_POST['lastMoveId']);
                echo $lastMoveIdLevel = preg_replace("/[^A-Za-z0-9 ]/", "", $_POST['lastMoveIdLevel']);
    ...
    if (isset($_POST['deleted'], $_POST['token'])) {
        ...
        if ($rwdelStrg['sl_id'] != $sl_id) {
            ...
            echo '<script>taskSuccess("index","' . $lang['Strg_Deleted_Successfully'] . '");</script>';
        } else {
    ...
    if (isset($_POST['bulkfoldownl'], $_POST['token'])) {
        ...
        //$download = mysqli_query($db_con, "select doc_name,doc_path,old_doc_name,doc_extn,doc_id from tbl_document_master where doc_id = 1171") or die('Error' . mysqli_error($db_con));
        ...
        while ($row = mysqli_fetch_assoc($download)) {
            ...
            // $filess = substr($row['old_doc_name'], 0, strrpos($row['old_doc_name'], '.'));
            // echo $filess;
            //             $file1 = $filess . '.' . $row['doc_extn'];
    ...
    if (isset($_POST['rename'], $_POST['token'])) {
        ...
        $nmevalidate = mysqli_query($db_con, "select old_doc_name, doc_extn from tbl_document_master where old_doc_name ='$nwfilnme'");
