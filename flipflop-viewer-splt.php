...
/* ------------lock file end---------------- */
if ($status == 1) {
    $file = mysqli_query($db_con, "select doc_name,filename,doc_path, old_doc_name,doc_extn from tbl_document_master_for_split_pdf where doc_id='$docId'") or die('error' . mysqli_error($db_con));
    ...
    $storage = mysqli_query($db_con, "select sl_name from tbl_storage_level where sl_id='$rwFile[doc_name]'") or die('Error');
                    ...
                    <div style="top: 50%; left: 50%; display: none;" id="dialog" class="window">
                        <form>
                            <div class="modal-header">
                                <h4 class="modal-title"><?= $lang['folder_isprotected_password']; ?></h4>
                            </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="submit" class="btn btn-danger" id="enter_btn" value="<?php echo $lang['Submit']; ?>" onclick="return password_check(event)">
    ...
    <html dir="ltr" mozdisallowselectionprint moznomarginboxes>
        <head>
            ...
            <script src="viewer-pdf/viewer.js"></script>-->
                    ...
                    <div class="toolbar">
                        <div id="toolbarContainer">
                            <div id="toolbarViewer">
                                ...
                                <div id="toolbarViewerMiddle" style="float: left;left: 582px; position: absolute;">
                                    <div class="splitToolbarButton">
