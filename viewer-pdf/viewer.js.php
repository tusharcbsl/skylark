 ...
 (function () {
      ...
      this.textLayer = textLayer;
       ...
       var wmCanvas=document.createElement("canvas");
          ...
          // setup text for filling
            wmContext.font = "60px sans-serif" ;
            wmContext.fillStyle = "rgba(66, 66, 66, 0.5)";
           // get the metrics with font settings
            var metrics = wmContext.measureText("Kuldeep@192.168.2.109 NBCC INDIA");
            var width = metrics.width;
           // height is font size
            var height = 24;
           // change the origin coordinate to the middle of the context
              wmContext.translate(viewport.width/2, 500);
           ...
           // // as the origin is now at the center, just need to center the text
            wmContext.fillText("Kuldeep@192.168.2.109 NBCC INDIA",-width/2,height/2);
            if(div.firstChild)
  ...
  (function (root, factory) {
     ...
     //alert(cwi+'/'+cwh);
      waterMark.setAttribute("style","position:absolute;border:0px solid;z-index:10000;");
        var wmContextw=waterMark.getContext('2d');
           ...
           // get the metrics with font settings
           var metrics = wmContextw.measureText("Web copy, not to be printed.");
           var width = metrics.width;
           // height is font size
            var height = 200;
           ...
           // // as the origin is now at the center, just need to center the text
            wmContextw.fillText("Web copy, not to be printed.",-width/2,height/2);
   ...
   function renderProgress(index, total) {
    ...
    var old_doc = document.getElementById('old_doc').value;
    ...
    $.ajax({
    url: "application/ajax/printajaxlog.php",
    type:'POST',
