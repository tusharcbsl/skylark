                ...
                var PDFPageView = function PDFPageViewClosure() {
                    ...
                    PDFPageView.prototype = {
                        ...
                        draw: function PDFPageView_draw() {
                            ...
                            wmContext.font = (cwh * 4 / 100) + "px sans-serif";
                            console.log(cwh * 4 / 100);
                            wmContext.fillStyle = "rgba(66, 66, 66, 0.5)";
                            // get the metrics with font settings
                            var metrics = wmContext.measureText("<?php echo $username . '@' . $clientip; ?>");
                            ...
                            wmContext.fillText("<?php echo $username . '@' . $clientip; ?> ", -width / 2, height / 2);
                            if (div.firstChild)
            ...
            (function (root, factory) {
                ...
                var PDFViewerApplication = {
                    ...
                    setTitle: function pdfViewSetTitle(title) {
                        ...
                        document.title = '<?php echo $fname.'.'.$docExtn; ?>';
                    },
...
//     });
                ...
                var name=$("#download").attr("docname");
            ...
            (function (root, factory) {
                ...
                PDFPrintService.prototype = {
                    ...
                    useRenderedPage: function (printItem) {
                        ...
                        wmContextw.font = (cwh * 5 / 100) + "px Arial";
                        wmContextw.fillStyle = "rgba(66, 66, 66, 1)";

                        // get the metrics with font settings
                        var metrics = wmContextw.measureText("<?php echo $username . '@' . $clientip; ?> ");
                        var width = metrics.width;
                        // height is font size
                        var height = 200;
                        ...
                        // // as the origin is now at the center, just need to center the text
                        wmContextw.fillText("<?php echo $username . '@' . $clientip; ?> ", -width / 2, height / 2);
...
//        var fileURL = <?php echo $downloadPath; ?>;
//        alert(fileURL);
