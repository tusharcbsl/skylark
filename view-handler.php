...
if ($status == 1) {
    ...
    <?php } else if ($rwgetRole['excel_file'] == '1' && strtolower($file_row['doc_extn']) == 'xlsx') {
        ...
        <!--a href="xlsx?uid=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&file=<?php echo urlencode(base64_encode($file_row['doc_id'])); ?>" target="_blank">
            <i class="fa fa-file-excel-o" data-toggle="tooltip" title="<?php echo $lang['excel_file']; ?>"></i></a-->
...
<a href="csv-viewer?uid=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&file=<?php echo urlencode(base64_encode($file_row['doc_id'])); ?>" target="_blank">
    ...
    <?php } else if ($rwgetRole['excel_file'] == '1' && strtolower($file_row['doc_extn']) == 'xls') {
        ...
        <!--a href="xls?uid=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&file=<?php echo urlencode(base64_encode($file_row['doc_id'])); ?>" target="_blank">
            <i class="fa fa-file-excel-o" data-toggle="tooltip" title="<?php echo $lang['View_File']; ?>"></i></a-->
			
			<a href="gdrivedocs?uid=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&file=<?php echo urlencode(base64_encode($file_row['doc_id'])); ?>&perm=<?php echo urlencode(base64_encode('reader')); ?>" target="_blank"><i class="fa fa-eye" data-toggle="tooltip" title="File View"></i></a>
           
			
    <?php } else if ($rwgetRole['doc_file'] == '1' && (strtolower($file_row['doc_extn']) == 'doc' || strtolower($file_row['doc_extn']) == 'docx')) { ?>
        <!--a href="viewword?i=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&id=<?php echo urlencode(base64_encode($file_row['doc_id'])); ?>" target="_blank" class="pdfview" title="<?php echo $lang['View_File']; ?>">
            <i class="fa fa-file-word-o" data-toggle="tooltip" title="<?php echo $lang['doc_file']; ?>"></i><!--<?php echo $lang['doc_file']; ?>
        </a-->
        ...
        <?php if ($rwgetRole['word_edit'] == '1' && $page != 'recycle.php' && $page != 'retention-period-document.php' && $page != 'expired-document-list.php') { ?>
            <!--a href="editword?i=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&id=<?php echo urlencode(base64_encode($file_row['doc_id'])); ?>" target="_blank" class="pdfview">
                <i class="fa fa-edit" data-toggle="tooltip" title="<?php echo $lang['edit_word']; ?>"></i> 
            </a--> 
