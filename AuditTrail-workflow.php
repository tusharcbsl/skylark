                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <?php echo $lang['WorkFlow_Audit']; ?>
                                    </li>
                                    <li> <a href="#" data-toggle="modal" data-target="#help-modal" id="helpview" data="26" title="<?= $lang['help']; ?>"><i class="fa fa-question-circle"></i> </a></li>
                        ...
                        <div class="box box-primary">
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="box-body">
                                        <div class="row">
                                            <form method="get">
                                                ...
                                                ?>
                                                <div class="col-md-3">
                                                    <select class="form-control select2" name="userLog">
                                                ...
                                                <div class="col-sm-3">
                                                    <select class="form-control select2" name="action">
                                                        ...
                                                        $action = mysqli_query($db_con, "SELECT DISTINCT `action_name` FROM `tbl_ezeefile_logs_wf` $where");
                                                        while ($rwaction = mysqli_fetch_assoc($action)) {

                                                            if($rwaction['action_name']!=""){
                                                            ?>
                                                            <option <?php
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <a href="AuditTrail-workflow" class="btn btn-warning"> <i class="fa fa-refresh"></i></a>
                                                </div>
                                            </form>
                                            <div class="col-md-1">
                                    ...
                                    $Auditwf = "select * from tbl_ezeefile_logs_wf $where";
                                    mysqli_set_charset($db_con, 'utf8');
                                    $runAuditwf = mysqli_query($db_con, $Auditwf) or die("Error: " . mysqli_error($con));
                                    $foundnum = mysqli_num_rows($runAuditwf);
                                    if ($foundnum > 0) {
                                        ...
                                        $allot = "select * from tbl_ezeefile_logs_wf $where order by start_date desc LIMIT $start, $per_page";
                                            ...
                                            <div class="box-body">
                                                <div class="m-b-10">
                                                    ...
                                                    <select id="limit" class="input-sm">
                                                        ...
                                                        ?>>500</option>
                                                    </select> <label><?php echo $lang['WorkFlow_Audit']; ?></label>
                                                    ...
                                                    <table class="table table-striped table-bordered js-sort-table">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="sort-js-date" ><?php echo $lang['Action_DateTime']; ?></th>
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $n = $start + 1;
                                                            while ($rwAuditwf = mysqli_fetch_assoc($allot_query)) {
                                                                ?>
                                                                <tr class="gradeX">
                                                                    <td>
                                                                        <?php if ($rwgetRole['delete_wf_log'] == '1') { ?>
                                                                    ...
                                                                    <td><?php echo $rwAuditwf['user_name']; ?></td>
                                                                    <td><?php echo $rwAuditwf['action_name']; ?></td>
                                                                    <td><?php echo date('d-m-Y H:i:s A', strtotime($rwAuditwf['start_date'])); ?></td>

                                                                    <td><?php echo $rwAuditwf['system_ip']; ?></td>
                                                                    <td><?php echo $rwAuditwf['remarks']; ?></td>

                                                                    <?php if ($rwgetRole['delete_wf_log'] == '1') { ?>
                                                                        <td> <button class="btn btn-danger" data-toggle="modal" data-target="#delHistory" id="deladit" data="<?php echo $rwAuditwf['id']; ?>"><i class="fa fa-trash-o" aria-hidden="true" title="<?php echo $lang['Delete']; ?>"></i> </button></td>
                                                                    <?php } ?>
                                                                </tr>
                                                                <?php
                                                                $n++;
                                                                ...
                                                                <tr>
                                                                    <td colspan="7">
                                                                        <ul class="delete_export" style="margin-left:-40px;">
                                                                            <li><button id="del_mul_histry" class="btn btn-danger" data-toggle="modal" data-target="#del_mul_history"><i class=" fa fa-trash-o"></i> <?php echo $lang['Delete_Audit']; ?></button></li>
                                                                        </ul>
                                                                    </td>
                                                                </tr>
                                                            <?php } ?>
    ...
    <div class="modal-dialog"> 
        <div class="panel panel-color panel-primary"> 
            <div class="panel-heading"> 
                ...
                <label><h2 class="panel-title"><?php echo $lang['export_workflow_audit']; ?></h2></label> 
            </div> 
            <form action="export-workflow-audit"  method="post">
                <div class="panel-body">
            ...
            <div class="panel panel-color panel-danger"> 
                ...
                <form method="post">
                    <div class="panel-body">
                        ...
                        <label id="multi_audit_hide"><p class="text-primary"><?php echo $lang['Are_you_sure_want_to_Del_selcted_his']; ?></p></label>
                    </div> 
                    <div class="modal-footer">
                        <input type="hidden" id="Del_multi_Audit" name="DelwfAudit" value="">
                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal"> <?php echo $lang['Close']; ?></button>
                        <button type="submit"  name="Del_wf_History" class="btn btn-danger" id="hiddelHis"><i class="fa fa-trash-o"></i> <?php echo $lang['Delete']; ?></button>
                        </button> 
                    </div>
                </form>
    ...
    <div id="delHistory" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog "> 
            <div class="panel panel-color panel-danger"> 
                ...
                <form method="post">
                    <div class="panel-body">
                        <label><p class="text-danger"><?php echo $lang['r_u_sure_want_to_Delt_audit_his']; ?></p></label>
                    </div> 
                    <div class="modal-footer">
                        <input type="hidden" id="AuditDel" name="DelwfHistry">
                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal"> <?php echo $lang['Close']; ?></button> 
                        <button type="submit" name="DelwfAdt" class="btn btn-danger"> <i class="fa fa-trash-o"></i> <?php echo $lang['Delete']; ?></button> 
                    </div>
                </form>
...
<?php
if (isset($_POST['DelwfAdt'], $_POST['token'])) {
    $AuditwfId = $_POST['DelwfHistry'];
    $delSnglAudit = mysqli_query($db_con, "DELETE FROM `tbl_ezeefile_logs_wf` WHERE id ='$AuditwfId'") or die("Error in del" . mysqli_error($db_con));
    if ($delSnglAudit) {
...
if (isset($_POST['Del_wf_History'], $_POST['token'])) {
    $AuditIds = $_POST['DelwfAudit'];
    $delAudit = mysqli_query($db_con, "DELETE FROM `tbl_ezeefile_logs_wf` WHERE id in($AuditIds)") or die("Error in del" . mysqli_error($db_con));
    if ($delAudit) {
        echo'<script>taskSuccess("' . basename($_SERVER['REQUEST_URI']) . '", "' . $lang['Audit_Deleted'] . '");</script>';
    } else {
        echo'<script>taskFailed("' . basename($_SERVER['REQUEST_URI']) . '", "' . $lang['Failed_Delete_Audit'] . '");</script>';
