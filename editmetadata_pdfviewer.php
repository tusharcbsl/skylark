                    ...
                    <div id="toolbarContainer">
                        <div id="toolbarViewer">
                            <div id="toolbarViewerLeft">
                                ...
                                <button type="button" style="display:none;"  title="Next Page" id="comment_button" style="color: #ffffff; margin-top: 3px;">Comment</button>
                            </div>
                    ...
                    <div class="comment-list">
                        <div class="comment-list-container">
                            <form method="post" enctype="multipart/form-data">
                                    ...
                                    while ($rwgetMetaName = mysqli_fetch_assoc($getMetaName)) {
                                        ...
                                        if ($rwgetMetaName['field_name'] == 'noofpages') {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <label for="userName"><?php echo $rwgetMetaName['field_name']; ?> <span style="color:red;">*</span></label>
                                                </div>
                                ...
                                <?php } ?>
                                <div class="row">
                                    <div class="col-md-12 m-t-20 m-l-15">
    ...
    function printwithlog(reason) {
        ...
        if (reason.length === 0) {
            ...
            $.post("viewer-pdf/printajaxlog.php", {remark: reason, docid: "<?php echo $dcid; ?>", docname: "<?php echo $docName; ?>", slid: "<?php echo $slid; ?>"}, function (result, status) {
                if (status == 'success') {
                    window.location = 'printInfo?id=' + did;
                    //alert(result);
                    //$("#child1").html(result);
                    //alert(result);
                }
...
//               
        ...
        echo $eng_memory = remaingSizeConvert($free_space_memory);
