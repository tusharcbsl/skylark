                        ...
                        <div class="panel">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <a href="shared-with-me" class="btn btn-warning"> <?php echo $lang['Reset']; ?></a>
                                        </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    $ShDocId = mysqli_query($db_con, "SELECT tdm.doc_id, tdm.doc_name,tdm.old_doc_name,tdm.doc_extn,tds.from_id,tds.to_ids,tds.doc_ids,tds.share_date FROM `tbl_document_share` tds INNER JOIN tbl_document_master tdm ON tds.doc_ids=tdm.doc_id $where") or die('Error in share with id fetch' . mysqli_error($db_con));
                                    ...
                                    if ($foundnum > 0) {
                                        ...
                                        <div class="box-body">
                                            ...
                                            <table class="table table-striped table-bordered js-sort-table"> 
                                                ...
                                                $ShareDoc = mysqli_query($db_con, "SELECT tdm.doc_id, tdm.doc_name,tdm.old_doc_name,tdm.doc_extn,tdm.checkin_checkout,tds.from_id,tds.to_ids,tds.doc_ids,tds.share_date,tds.doc_share_valid_upto FROM `tbl_document_share` tds INNER JOIN tbl_document_master tdm ON tds.doc_ids=tdm.doc_id $where order by tdm.old_doc_name LIMIT $start, $per_page"); //or die('Error in share id fetch' . mysqli_error($db_con));
                                                if (mysqli_num_rows($ShareDoc) > 0) {
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="sort-js-date"><?php echo $lang['Valid_datetime']; ?></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            <tr class="gradeX">
                                                                <td><?php echo $i . '.'; ?></td>
                                                                 <td>
                                                                    ...
                                                                    if(file_exists('thumbnail/'.base64_encode($rwShareName['doc_id']).'.jpg')){ ?><div> <img class="thumb-image" src="thumbnail/<?=base64_encode($rwShareName['doc_id'])?>.jpg"> </div>
                                                                    <?php } 
                                                                ...
                                                                <?php if (!empty($rwShareName['doc_share_valid_upto']) && $rwShareName['doc_share_valid_upto']!='') { ?>
                                                                    <td><?php echo '<label class="label label-danger">' . date('d-m-Y h:i:s A', strtotime($rwShareName['doc_share_valid_upto'])) . '</label>'; ?></td>    
                                                                <?php } else { ?>
                                                                    <td><?php echo '<label class="label label-primary">' .$lang['unlimited']. '</label>'; ?></td> 
                                                                <?php } ?>
                                                            </tr>
                                                            <?php
                                                            $i++;
                                            ...
                                            <table class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><?php echo $lang['Valid_datetime']; ?></th>
                                                </thead>
                                                </tr>
                                                <?php
                                                if (isset($_GET['shared_doc']) && !empty($_GET['shared_doc'])) {
                                                    echo '<tr><td colspan="6" class="text-center"><label><strong class="text-danger"><i class="ti-face-sad text-pink"></i> ' . $lang['Who0ps!_No_Records_Found'] . '</strong></label></td></tr>';
                                                } else {
                                                    echo '<tr><td colspan="6" class="text-center"><label><strong class="text-danger">' . $lang['Yu_Hv_No_Shred_Fles'] . '</strong></label></td></tr>';
                                                }
                                                ?>
                                            </table>
                                        <?php }
