    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                                        ...
                                        <form method="get">
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <select class="form-control select2" id="statusTask" name="taskStats">
                                                        <option selected value=""><?php echo $lang['Sl_Tsk_Sts']; ?></option>
                                                        <option  <?php
                                                        ...
                                                        ?>><?php echo ucwords($lang['approved']); ?></option>
                                                        <option  <?php
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <select class="form-control select2" id="" name="taskPrioty">
                                                        <option selected value=""><?php echo $lang['Slct_Prty']; ?></option>
                                                        <option value="3" <?php
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <div class="input-daterange input-group" id="date-range">
                                                            <input type="text" class="form-control" name="startDate" value="<?php echo $_GET['startDate']; ?>" placeholder="<?= $lang['dd_mm_yyyy']; ?>" title="<?= $lang['dd_mm_yyyy']; ?>" />
                                                            <span class="input-group-addon bg-custom b-0 text-white"><?php echo $lang['to']; ?></span>
                                                            <input type="text" class="form-control" name="endDate" value="<?php echo $_GET['endDate']; ?>"   placeholder="<?= $lang['dd_mm_yyyy']; ?>" title="<?= $lang['dd_mm_yyyy']; ?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <select class="form-control select2" id="" name="asinBy">
                                                        <option selected value=""><?php echo $lang['Select_Assign_By']; ?></option>
                                                        <?php
                                                        $assign_by = array();
                                                        ...
                                                        if (!empty($assign_by) || $_SESSION['cdes_user_id'] == 1) {
                                                            ...
                                                            while ($userAsinBy_row = mysqli_fetch_assoc($userAsinBy_query)) {
                                                                if ($userAsinBy_row['user_id'] != 1 && $userAsinBy_row['user_id'] != $_SESSION['cdes_user_id']) {
                                                                    ...
                                                                    ?>><?php echo $userAsinBy_row['first_name'] . ' ' . $userAsinBy_row['last_name']; ?></option>
                                            ...
                                            <div class="col-sm-3">
                                                <button class="btn btn-primary waves-effect waves-light" type="submit" name="fltr"><i class="fa fa-filter"></i>
                                                    <?php echo $lang['Apply_Filter']; ?>
                                                </button>
                                                <input type="button" class="btn btn-warning" id="reset" value="<?php echo $lang['Reset'] ?>">
                                            </div>  
                                        </form>
                                    </div>
                                    <div class="box-body">
                                        ...
                                        if ($foundnum > 0) {
                                            ...
                                            $limit = $_GET['limit'];
                                            if ($_SESSION['cdes_user_id'] == 1) {
                                                $allot = "SELECT tdawf.id,tsm.task_name,tsm.task_order,tdawf.doc_id,tdawf.task_status,tdawf.task_remarks,tdawf.start_date,tsm.deadline,tsm.deadline_type,tsm.priority_id,tdawf.assign_by,tdawf.NextTask FROM tbl_task_master tsm inner join tbl_doc_assigned_wf tdawf on tsm.task_id=tdawf.task_id $where LIMIT $start, $per_page";
                                            } else {
                                                $allot = "SELECT tdawf.id,tdawf.ticket_id,tsm.task_name,tsm.task_order,tdawf.doc_id,tdawf.task_status,tdawf.task_remarks,tdawf.start_date,tsm.deadline,tsm.deadline_type,tsm.priority_id,tdawf.assign_by,tdawf.NextTask FROM tbl_task_master tsm inner join tbl_doc_assigned_wf tdawf on tsm.task_id=tdawf.task_id $where  LIMIT $start, $per_page";
                                            }
                                            ...
                                            <div class="container" >
                                                <div class="col-md-6">
                                                    <?php echo $lang['Show'] ?> <select id="limit1">
                                                        <option value="10" <?php
                                                        if ($_GET['limit'] == 10) {
                                                            echo 'selected';
                                                        }
                                                ...
                                                <div class="pull-right record m-b-10">
                                                        ...
                                                        while ($allot_row = mysqli_fetch_assoc($allot_query)) {
                                                            ...
                                                            <tr class="gradeX" style="vertical-align: middle;">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    ?>" title="<?php echo $lang['Process_Task']; ?>" <?= $anc_attr; ?>> <i class="glyphicon glyphicon-new-window task"></i></a>
                                                                </td>
                                                                <td><?php
                                                                    echo $allot_row['task_name'];
                                                                    // echo $allot_row['ticket_id'];
                                                                    ?></td>
                                                                <td><?php
                                                                    if (!empty($allot_row['doc_id'])) {
                                                                        $doc = mysqli_query($db_con, "select * from tbl_document_master where doc_id='$allot_row[doc_id]'") or die('Error' . mysqli_error($db_con));
                                                                        ...
                                                                        <?php if (strtolower($rwDoc['doc_extn']) == 'pdf') {
                                                                            ...
                                                                            <a href="viewer?id=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])) ?>&i=<?php echo urlencode(base64_encode($rwDoc['doc_id'])); ?>&pn=1" class="pdfview" target="_blank" title="<?php echo $rwDoc['old_doc_name']; ?>">
                                                                                <?php echo substr($rwDoc['old_doc_name'], 0, 20); ?>
                                                                                <i class="fa fa fa-file-text-o" title="<?= $lang['view_copy_print']; ?>"></i></a>

                                                                            <?php
                                                                            if ($allot_row['NextTask'] == 2 || (($allot_row['task_status'] == 'Approved' || $allot_row['task_status'] == 'Processed' || $allot_row['task_status'] == 'Done') && ($allot_row['NextTask'] == 1)) || $allot_row['task_status'] == 'Rejected' || $allot_row['task_status'] == 'Complete') {
                                                                                
                                                                            } else {
                                                                                echo '<a href="anott/index?id=' . urlencode(base64_encode($_SESSION[cdes_user_id])) . '&id1=' . urlencode(base64_encode($rwDoc['doc_id'])) . '&pn=1&tid=' . urlencode(base64_encode($allot_row[id])) . '" class="pdfview" target="blank" ><i class="fa fa-edit"></i></a>';
                                                                            }
                                                                            ?>

                                                                            <?php
                                                                        } else if (strtolower($rwDoc['doc_extn']) == 'jpg' || strtolower($rwDoc['doc_extn']) == 'png' || strtolower($rwDoc['doc_extn']) == 'gif') {
                                                                            ?>
                                                                            <a href="imageviewer?uid=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&i=<?php echo urlencode(base64_encode($rwDoc['doc_id'])); ?>"  target="_blank" title="<?php echo $rwDoc['old_doc_name']; ?>"> 
                                                                                <?php if ($rwgetRole['image_file'] == '1') { ?>
                                                                                    <?php echo substr($rwDoc['old_doc_name'], 0, 20); ?>  <i class="fa fa-file-image-o"></i></a>
                                                                                <?php } ?>
                                                                            <?php } else if (strtolower($rwDoc['doc_extn']) == 'tif' || strtolower($rwDoc['doc_extn']) == 'tiff') { ?>
                                                                            <a href="file?uid=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&file=<?php echo urlencode(base64_encode($rwDoc['doc_id'])); ?>" target="_blank" title="<?php echo $rwDoc['old_doc_name']; ?>">
                                                                                <?php if ($rwgetRole['tif_file'] == '1') { ?>
                                                                                    <?php echo substr($rwDoc['old_doc_name'], 0, 20); ?> <i class="fa fa-picture-o"></i>
                                                                                </a>
                                                                            <?php } ?>

                                                                        <?php } else if (strtolower($rwDoc['doc_extn']) == 'xlsx') {
                                                                            ?>
                                                                            <a href="xlsx?uid=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&file=<?php echo urlencode(base64_encode($rwDoc['doc_id'])); ?>" target="_blank" title="<?php echo $rwDoc['old_doc_name']; ?>">
                                                                                <?php if ($rwgetRole['excel_file'] == '1') { ?>
                                                                                    <?php echo substr($rwDoc['old_doc_name'], 0, 20); ?> <i class="fa fa-file-excel-o"></i></a>
                                                                                <?php } ?>

                                                                        <?php } else if (strtolower($rwDoc['doc_extn']) == 'xls') {
                                                                            ?>
                                                                            <a href="xls?uid=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&file=<?php echo urlencode(base64_encode($rwDoc['doc_id'])); ?>" target="_blank" title="<?php echo $rwDoc['old_doc_name']; ?>">
                                                                                <?php if ($rwgetRole['excel_file'] == '1') { ?>
                                                                                    <?php echo substr($rwDoc['old_doc_name'], 0, 20); ?> <i class="fa fa-file-excel-o"></i></a>
                                                                                <?php } ?>
                                                                        ...
                                                                        <?php } else if (strtolower($rwDoc['doc_extn']) == 'doc' || strtolower($rwDoc['doc_extn']) == 'docx') { ?>
                                                                            <?php if ($rwgetRole['doc_file'] == '1') { ?>
                                                                                <a href="viewword?i=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&id=<?php echo urlencode(base64_encode($rwDoc['doc_id'])); ?>" target="_blank" title="<?php echo $rwDoc['old_doc_name']; ?>">
                                                                                    <?php echo substr($rwDoc['old_doc_name'], 0, 20); ?> <i class="fa fa-file-word-o"></i></a>
                                                                                <?php } ?>

                                                                            <?php if ($rwgetRole['word_edit'] == '1') { ?>
                                                                                <a href="editword.php?i=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&id=<?php echo urlencode(base64_encode($rwDoc['doc_id'])); ?>" target="_blank"><i class="fa fa-edit"></i></a>
                                                                            <?php } ?>

                                                                        <?php } else if (strtolower($rwDoc['doc_extn']) == 'psd') { ?><?php if ($rwgetRole['view_psd'] == '1') { ?>
                                                                                <a href="viewword?i=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&id=<?php echo urlencode(base64_encode($rwDoc['doc_id'])); ?>" target="_blank" title="<?php echo $rwDoc['old_doc_name']; ?>"><?php echo substr($rwDoc['old_doc_name'], 0, 20); ?><img src="<?= BASE_URL ?>assets/images/psd.png"></a>
                                                                            <?php } ?>
                                                                        <?php } else if (strtolower($rwDoc['doc_extn']) == 'cdr') { ?> <?php if ($rwgetRole['view_cdr'] == '1') { ?>
                                                                                <a href="viewword?i=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&id=<?php echo urlencode(base64_encode($rwDoc['doc_id'])); ?>" target="_blank" title="<?php echo $rwDoc['old_doc_name']; ?>"><?php echo substr($rwDoc['old_doc_name'], 0, 20); ?><img src="<?= BASE_URL ?>assets/images/cdr.png"></a>
                                                                            <?php } ?>

                                                                        <?php } else if (strtolower($rwDoc['doc_extn']) == 'mp3' || strtolower($rwDoc['doc_extn']) == 'wav') { ?>

                                                                            <a href="javascript:void(0)" data-toggle="modal" data-target="#modal-audio" data="<?php echo $rwDoc['doc_id']; ?>" id="audio" title="<?php echo $rwDoc['old_doc_name']; ?>">
                                                                                <?php if ($rwgetRole['audio_file'] == '1') { ?>
                                                                                    <?php echo substr($rwDoc['old_doc_name'], 0, 20); ?> <i class="fa fa-music"></i> Audio </a>
                                                                                <?php } ?>

                                                                        <?php } else if (strtolower($rwDoc['doc_extn']) == 'mp4' || strtolower($rwDoc['doc_extn']) == '3gp') { ?>
                                                                            <a href="javascript:void(0)" data-toggle="modal" data-target="#modal-video" data="<?php echo $rwDoc['doc_id']; ?>" id="video" title="<?php echo $rwDoc['old_doc_name']; ?>">
                                                                                <?php if ($rwgetRole['video_file'] == '1') { ?>
                                                                                    <?php echo substr($rwDoc['old_doc_name'], 0, 20); ?> <i class="fa fa-video-camera"></i> Video</a>
                                                                                <?php } ?>
                                                                            <?php } else {
                                                                                ?>
                                                                            <a href="downloaddoc.php?file=<?php echo urlencode(base64_encode($rwDoc['doc_id']))?>" id="fancybox-inner" target="_blank"> <i class="fa fa-download"></i> <?php echo $rwDoc['old_doc_name']; ?>
                                                                            </a>
                                                                            <?php
                                                                        }
                                                                        ...
                                                                        while ($rwfileVersion = mysqli_fetch_assoc($fileVersion)) {
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                if (strtolower($rwfileVersion['doc_extn']) == 'pdf') {
                                                                                    ...
                                                                                    if ($allot_row['NextTask'] == 2 || (($allot_row['task_status'] == 'Approved' || $allot_row['task_status'] == 'Processed' || $allot_row['task_status'] == 'Done') && ($allot_row['NextTask'] == 1)) || $allot_row['task_status'] == 'Rejected' || $allot_row['task_status'] == 'Complete') {
                                                                                        ?>
                                                                                        <a href="viewer?id=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])) ?>&i=<?php echo urlencode(base64_encode($rwfileVersion['doc_id'])); ?>&pn=1" class="pdfview" target="_blank"><?php echo substr($rwfileVersion['old_doc_name'], 0, 20); ?>
                                                                                            <i class="fa fa fa-file-text-o" title="<?= $lang['view_copy_print']; ?>"></i></a>
                                                                                        <?php
                                                                                    } else {
                                                                                        echo '<a href="anott/index?id=' . urlencode(base64_encode($_SESSION[cdes_user_id])) . '&id1=' . urlencode(base64_encode($rwfileVersion['doc_id'])) . '&pn=1&tid=' . urlencode(base64_encode($allot_row[id])) . '" class="pdfview" target="blank">' . substr($rwfileVersion['old_doc_name'], 0, 20) . '<i class="fa fa-edit"></i></a>';
                                                                                    }
                                                                                    ?> 
                                                                                    <?php
                                                                                }
                                                                                if ((strtolower($rwfileVersion['doc_extn']) == 'gif' || strtolower($rwfileVersion['doc_extn']) == 'jpg' || strtolower($rwfileVersion['doc_extn']) == 'png') && $rwgetRole['image_file'] == '1') {
                                                                                    ?>
                                                                                    <a href="imageviewer?uid=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&i=<?php echo urlencode(base64_encode($rwfileVersion['doc_id'])); ?>"  target="_blank" title="<?php echo substr($rwfileVersion['old_doc_name']); ?> ">
                                                                                        <?php echo substr($rwfileVersion['old_doc_name'], 0, 20); ?> 
                                                                                ...
                                                                                <?php } if (strtolower($rwfileVersion['doc_extn']) == 'tif' || strtolower($rwfileVersion['doc_extn']) == 'tiff') { ?>
                                                                                    <a href="file?uid=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&file=<?php echo urlencode(base64_encode($rwfileVersion['doc_id'])); ?>" target="_blank" title="<?php echo $rwfileVersion['old_doc_name']; ?>">
                                                                                        <?php echo substr($rwfileVersion['old_doc_name'], 0, 20); ?> <i class="fa fa-picture-o"></i></a>


                                                                                    <!--viewer for excel versioning-->
                                                                                <?php } else if (strtolower($rwfileVersion['doc_extn']) == 'xlsx') {
                                                                                    ?>
                                                                                    <a href="xlsx?uid=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&file=<?php echo urlencode(base64_encode($rwfileVersion['doc_id'])); ?>" target="_blank" title="<?php echo $rwfileVersion['old_doc_name']; ?>">
                                                                                        <?php if ($rwgetRole['excel_file'] == '1') { ?>
                                                                                            <?php echo substr($rwfileVersion['old_doc_name'], 0, 20); ?> <i class="fa fa-file-excel-o"></i></a>
                                                                                        <?php } ?>

                                                                                <?php } else if (strtolower($rwfileVersion['doc_extn']) == 'xls') {
                                                                                    ?>
                                                                                    <a href="xls?uid=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&file=<?php echo urlencode(base64_encode($rwfileVersion['doc_id'])); ?>" target="_blank" title="<?php echo $rwfileVersion['old_doc_name']; ?>">
                                                                                        <?php if ($rwgetRole['excel_file'] == '1') { ?>
                                                                                            <?php echo (substr($rwfileVersion['old_doc_name'], 0, 20)); ?> <i class="fa fa-file-excel-o"></i></a>
                                                                                        <?php } ?>
                                                                                ...
                                                                                <?php } if (strtolower($rwfileVersion['doc_extn']) == 'doc' || strtolower($rwfileVersion['doc_extn']) == 'docx') { ?>
                                                                                    <?php if ($rwgetRole['doc_file'] == '1') { ?>
                                                                                        <a href="viewword?i=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&id=<?php echo urlencode(base64_encode($rwfileVersion['doc_id'])); ?>" target="_blank" title="<?php echo $rwfileVersion['old_doc_name']; ?>">
                                                                                            <?php echo substr($rwfileVersion['old_doc_name'], 0, 20); ?> <i class="fa fa-file-word-o"></i></a>
                                                                                        <?php } ?>
                                                                                        <?php if ($rwgetRole['word_edit'] == '1') { ?>
                                                                                        <a href="editword.php?i=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&id=<?php echo urlencode(base64_encode($rwfileVersion['doc_id'])); ?>" target="_blank" title="<?php echo $rwfileVersion['old_doc_name']; ?>">
                                                                                            <i class="fa fa-edit"></i></a>
                                                                                    <?php } ?>
                                                                                    <!--for PSD viewer version-->
                                                                                <?php } if (strtolower($rwfileVersion['doc_extn']) == 'psd') { ?>
                                                                                    <?php if ($rwgetRole['view_psd'] == '1') { ?>
                                                                                        <a href="viewword?i=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&id=<?php echo urlencode(base64_encode($rwfileVersion['doc_id'])); ?>" target="_blank" title="<?php echo $rwfileVersion['old_doc_name']; ?>">
                                                                                            <?php echo substr($rwfileVersion['old_doc_name'], 0, 20); ?><img src="<?= BASE_URL ?>assets/images/psd.png"></a>
                                                                                    <?php } ?>

                                                                                    <!--for CDR viewer version-->
                                                                                <?php } if (strtolower($rwfileVersion['doc_extn']) == 'cdr') { ?>
                                                                                    <?php if ($rwgetRole['view_cdr'] == '1') { ?>
                                                                                        <a href="viewword?i=<?php echo urlencode(base64_encode($_SESSION[cdes_user_id])); ?>&id=<?php echo urlencode(base64_encode($rwfileVersion['doc_id'])); ?>" target="_blank" title="<?php echo $rwfileVersion['old_doc_name']; ?>">
                                                                                            <?php echo substr($rwfileVersion['old_doc_name'], 0, 20); ?><img src="<?= BASE_URL ?>assets/images/cdr.png"></a>
                                                                                    <?php } ?>


                                                                                    <!--for audio/video viewer version-->
                                                                                <?php } if (strtolower($rwfileVersion['doc_extn']) == 'mp3') { ?>
                                                                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#modal-audio" data="<?php echo $rwfileVersion['doc_id']; ?>" id="audio" title="<?php echo $rwfileVersion['old_doc_name']; ?>"> <?php echo substr($rwfileVersion['old_doc_name'], 0, 20); ?> <i class="fa fa-music"></i> </a>
                                                                                <?php } if (strtolower($rwfileVersion['doc_extn']) == 'mp4') { ?>
                                                                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#modal-video" data="<?php echo $rwfileVersion['doc_id']; ?>" id="video" title="<?php echo $rwfileVersion['old_doc_name']; ?>"> <?php echo substr($rwfileVersion['old_doc_name'], 0, 20); ?> <i class="fa fa-video-camera"></i></a>

                                                                                    <?php
                                                                                }
                                                                                if (strtolower($rwfileVersion['doc_extn']) == 'csv') { ?>
                                                                                    <a href="downloaddoc.php?file=<?php echo urlencode(base64_encode($rwfileVersion['doc_id']))?>" id="fancybox-inner" target="_blank"> <i class="fa fa-download"></i> <?php echo $rwfileVersion['old_doc_name']; ?>
                                                                                </a>
                                                                                    <?php
                                                                                }
                                                                            }
                                                                ...
                                                                <td><?php echo date("d-m-Y H:i:s", strtotime($allot_row['start_date'])); ?></td>

                                                                <td><?php
                                                                    $tsk_order = $allot_row['task_order'] - 1;

                                                                    $user_sent = mysqli_query($db_con, "select u.first_name,u.last_name from tbl_doc_assigned_wf as wa
                                                                        left join tbl_user_master as u on wa.action_by=u.user_id
                                                                        left join tbl_task_master as tm on wa.task_id=tm.task_id
                                                                        where wa.ticket_id='$allot_row[ticket_id]' and tm.task_order='$tsk_order' ");
                                                                    ...
                                                                    if ($tsk_order == '0') {
                                                                        ...
                                                                        echo $rwUserSent['first_name'] . ' ' . $rwUserSent['last_name'];
                                                                    }
                                                                    ?></td>
                                                                ...
                                                                <td><?php
                                                                    if ($tsk_order == '0') {
                                                                        ...
                                                                        echo date("d-m-Y H:i:s", strtotime($allot_row['start_date']));
                                                                    }
                                                                    ?>
                                                                ...
                                                                <td><?php
                                                                    if ($allot_row['deadline_type'] == 'Date') {
                                                                        ...
                                                                        if ($remainTime > 0) {
                                                                            echo '<span class="succes">' . humanTiming($remainTime) . '</span>';
                                                                        } else {
                                            ...
                                            echo '<h5 class="text-center task"><label class="text-danger"><b>' . $lang['u_Hav_No_Tsk'] . '</b></label></h5>';
                                        }
                                        ?>
                                    </div>
                                </div>
                ...
                <div id="con-close-modal-act" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        ...
        <script type="text/javascript">
            ...
            $('#con-close-modal-act').on('show.bs.modal', function (e) {
                var tid = $("#tid").val();
                //alert(tid);
                $.post("<?= BASE_URL ?>application/ajax/task-process.php", {tid: tid}, function (result, status) {
                    if (status == 'success') {
...
//                $ltaskName = $rwlogTaskName['task_name'];
            ...
            if (FTP_ENABLED) {
                ...
                if ($ftp->put(ROOT_FTP_FOLDER . '/images/' . $storageName . '/' . $filenameEnct, $uploaddir)) {
                    $upload = true;
                    //unlink($uploaddir);
                } else {
                    $upload = false;
